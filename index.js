(function () {
    function a() {
      ...
      if (12 <= d) {
        ...
        "" === g &&
          ((g = "Android User " + Math.floor(1e3 * Math.random())),
          e.saveString(20, g));
      } else
        5 <= d
          ? ((g = e.loadString(0)),
            "" === g &&
              ((g = "Player " + Math.floor(1e3 * Math.random())),
              e.saveString(0, g)))
          : (g = f.g(0));
      return g;
    }
    ...
    function p() {
      if (b) q = c.zoom || r < s;
        ...
        -1 === g
          ? ((q = 100 >= e.getNumber(0) || r < s),
            e.saveNumber(21, q ? 1 : 0))
          : (q = 1 === g || r < s);
      } else
        5 <= d
          ? ((g = e.loadNumber(1)),
            2 === g
              ? ((q = !0), e.saveNumber(1, q ? 1 : 0))
              : (q = 1 === g))
          : (q = 0 === f.g(4) || r < s);
    }
    function u() {
    ...
    function a1(g, k) {
      b
        ...
        : 12 <= d
        ? (e.saveNumber(22, k ? 1 : 0), e.saveNumber(21, g ? 1 : 0))
        : 5 <= d
        ? (e.saveNumber(1, g ? 1 : 0), e.saveNumber(11, k ? 1 : 0))
        : (f.x(2, k ? 1 : 0), f.x(4, g ? 0 : 1), f.y());
    }
    function a3() {
    ...
    function bW() {
      for (var g = aQ - 1; 0 <= g; g--)
        b4[aM].push(aS[g]), bM[aM].push(aS[g]), b5.b7(aS[g], aM);
    }
    function bm() {
      var g = 1,
        k = [null, null];
      this.bp = function () {
        g = 0.72 * (q ? 0.0011 : 0.001) * bq;
        for (var t = 1; 0 <= t; t--) k[t] && this.br(t, k[t].l);
      };
      this.br = function (t, l) {
        k[t] = { l: l, font: bt + 10 + bu };
        this.bv(t);
      };
      this.bv = function (t) {
        if (bw.bx() && k[t]) {
          var l = k[t].l,
            y = Math.floor(0.15 * g * bw.bz(13).height),
            n = bt + y + bu,
            z = c2.measureText(l, n),
            x = 0.8 * g * bw.bz(13).width;
      ...
      this.c7 = function (t, l) {
        return !bw.bx() ||
          t < cA ||
          l < cB - cC.c1 - g * bw.bz(13).height - 2 * cA ||
          l > cB - cC.c1 - 2 * cA
          ? !1
          : t < cA + g * bw.bz(13).width
          ? (cD.cE(0), !0)
          : t < 2 * cA + g * bw.bz(13).width
          ? !1
          : t < 2 * cA + 2 * g * bw.bz(13).width
          ? (cD.cE(1), !0)
          : !1;
      };
      this.cF = function () {
        ...
        if (bw.bx()) {
          ...
          for (var t = 1; 0 <= t; t--)
            k[t] &&
              ...
              cH.fillText(
                k[t].l,
                0.5 * g * bw.bz(13).width,
                0.86 * g * bw.bz(13).height
              ));
    ...
    function cY(g, k) {
      ...
      a: for (; 0 <= y; y -= n)
        for (l = 3; 0 <= l; l--) {
          ...
          if (
            z === b8 ||
            (b5.bE(bM[g][y] + aV[l]) && z !== g && (k || ch(g, z)))
          ) {
            for (t = cg - 1; 0 <= t; t--) if (ci[t] === z) continue a;
            ci[cg] = z;
            if (++cg >= cj) return !0;
          }
        }
    ...
    function ck(g, k) {
      ...
      for (t = bM[g].length - 1; 0 <= t; t--)
        for (l = 3; 0 <= l; l--) {
          ...
          if (
            y === b8 ||
            (b5.bE(bM[g][t] + aV[l]) && y !== g && (k || ch(g, y)))
          )
            return (ci[cg++] = y), !0;
        }
      return !1;
    ...
    function cp() {
      var g;
      for (g = cg - 1; 0 <= g; g--) if (ci[g] >= cq) return !0;
      return !1;
    }
    function cr() {
      var g, k;
      for (g = cg - 1; 0 <= g; g--)
        if (ci[g] < cq) for (cg--, k = g; k < cg; k++) ci[k] = ci[k + 1];
      return 0 < cg;
    }
    function cs(g) {
      var k,
    ...
    function cv(g) {
      ...
      for (g = cg - 1; 1 <= g; g--) {
        var n =
          d5(t - as(cz[ci[g]] + d0[ci[g]], 2)) +
          d5(l - as(d2[ci[g]] + d3[ci[g]], 2));
        n < y && ((y = n), (k = ci[g]));
      }
      return k;
    }
    ...
    function dB(g, k) {
      ...
      if (ae.dD(g) && !(60 > k))
        if (0 === bM[g].length)
          dE.dF(g, dG.cN[g - cq]) ||
            (dG.dH(g - cq, 200), dI(g, k, dG.cN[g - cq], ay.dJ(g)));
        else if (
          !(
            0 < bN[g].length &&
            ce.random() < ce.value(bN[g].length > bM[g].length ? 7 : 3) &&
            dE.dF(g, dG.cN[g - cq])
          )
        ) {
          var t = ay.dJ(g);
        ...
        ? ((d7[g] = 1),
          cn(g) ||
            (cl()
              ...
              : (ce.dP(dG.dQ[t])
                  ? (l = cs(g))
                  : (cp() && ce.dP(dG.dS[t]) && cr(), (l = cv(g))),
                dR(g, k, l),
                dO(g, l, t))))
        : (0 < bN[g].length && ce.random() < ce.value(60) && dE.dF(g, t)) ||
          (dG.dH(g - cq, 200), dI(g, k, t, l));
    }
    function dT(g, k) {
      cY(g, !1) || ck(g, !1)
        ? ((d7[g] = 1), cl() ? dN(g, k) : dR(g, k, d6()))
        : dI(g, k, 0, 0);
    }
    function dO(g, k, t) {
      3 <= t &&
        2142 < c4.dU() &&
        (k === b8 || ax[k] < as(ax[g], 20)) &&
        dG.dH(g - cq, 25);
    }
    function dI(g, k, t, l) {
      if (
        0 !== dW.dX[g] &&
        !((5 === t && ax[g] < l) || (4 === t && ax[g] < as(l, 2)))
      )
    ...
    function dL(g, k, t) {
      (!cY(g, !0) && !ck(g, !0)) ||
        ...
        (cl()
          ...
          : ce.dP(dG.dQ[t])
          ? dR(g, k, cs(g))
          : (cp() && ce.dP(dG.dS[t]) && cr(), dR(g, k, cv(g))));
    }
    function db(g, k) {
    ...
    function de() {
      ...
      this.bp = function () {
        ...
        if (dr.ds) {
          ...
          if (dA)
            for (z = dq - 1; 0 <= z; z--)
              this.cN[z] = dy.dz[dW.dX[z + cq] - 1].bD;
          else for (z = dq - 1; 0 <= z; z--) this.cN[z] = dy.dz[0].bD;
        else {
          var x = 8 === dv ? 1 : 0;
        ...
        for (z = dq - 1; 0 <= z; z--)
          2 >= this.cN[z]
            ...
            ? ((l[z] = 1 + ce.cf(20)),
              ...
              (y[z] = 500 + ce.cf(501)),
              3 === this.cN[z]
                ? ((k[z] = 600 + ce.cf(101)), (t[z] = 300 + ce.cf(401)))
                : ((k[z] = 300 + ce.cf(201)), (t[z] = 100 + ce.cf(201))))
            : ((y[z] = 1e3),
              (n[z] = 1e3),
              (l[z] = 35 + ce.cf(16)),
              (k[z] = 400 + ce.cf(101)),
    ...
    function ee() {
      ...
      this.dF = function () {
        ...
        x = ax[aw];
        for (A = l - 1; 0 <= A; A--)
          10 === n[y[A]] ? k(y[A]) : 0 === n[y[A]]-- && (k(y[A]), ab(y[A]));
      ...
      this.cR = function (A, B) {
        var C;
        for (C = l - 1; 0 <= C; C--) if (A === y[C]) return;
        y[l++] = A;
        n[A] = B ? 2 : 10;
      };
    }
    function es() {
      function g() {
        ...
        a: {
          for (var x = 40; 1 <= x; x--) {
            y =
              d0[z] + as(ce.random() * (cz[z] - d0[z] + 1), ce.value(100));
            n =
              d3[z] + as(ce.random() * (d2[z] - d3[z] + 1), ce.value(100));
            var A = k(b5.f2(y, n));
            if (1 !== A) break a;
          }
          A = 1;
    ...
    function fI() {
      ...
      this.fN = function (x, A, B, C) {
        0 !== fG[x] &&
          2 !== fU[k] &&
          f0.co(x, b5.f2(B, C)) &&
          ez(x, f0.f1(), b5.f2(B, C), as(A * ax[x], 1e3)) &&
          x === aw &&
          ((b0.b1[0] += A), b0.b1[1]++, b0.b1[2]++);
      };
    ...
    function fu() {
      ...
      this.dF = function () {
        for (var B = l - 1; 0 <= B; B--)
          0 === n[B]-- && ((n[B] = 2), g1.dF(B, z[B], y[B], x[B], A[B]));
      };
      ...
      this.g3 = function (B) {
        var C;
        for (C = l - 1; 0 <= C; C--) B === y[C] && (g1.g4(B, x[C]), g(C));
      };
        ...
        if (!(40 > g7 || 0 === l)) {
          ...
          for (B = l - 1; 0 <= B; B--) {
            ...
            if (M > C - 1 && M < G && H > E - 1 && H < F && 0 !== fG[D]) {
              var K = Math.floor(0.94 * g7 * eA.gG(D));
              if (!(6 > K)) {
                M = Math.floor((gE * (M + 0.5 - C)) / (G - C));
                H = Math.floor((cB * (H + 0.48 - E)) / (F - E));
                cH.font = bt + K + bu;
                cH.fillStyle = gH;
                var J = ae.am(D, ae.fW(D, z[B]));
                cH.fillText(gI.gJ.gK ? eP.gL(J) : gM[D], M, H);
                var L = Math.floor(0.5 * K);
                6 > L ||
                  ((cH.font = bt + L + bu),
                  cH.fillText(
                    gI.gJ.gK ? gM[D] : eP.gL(J),
                    M,
                    H + Math.floor(0.82 * K)
                  ));
              }
    ...
    function gN() {
      ...
      function k(J) {
        0.125 > Math.abs(Math.log(F / C)) && (F = J * C);
      }
      function t(J, L, P, I) {
        E = (J + P + 1) / 2;
        G = (L + I + 1) / 2;
    ...
    function hD() {
      ...
      function k() {
        ...
        for (H = J + G - 1; H >= J; H--)
          for (D = L + G - 1; D >= L; D--)
            if (((K = b5.f2(D, H)), !b5.b6(K) || b5.cU(K))) return !1;
        return !0;
      }
      function t() {
        fG[F] = 0;
      ...
      function l(H, D) {
        ...
        for (L = bU[F] - 1; 0 <= L; L--)
          b5.hi(M[L], F)
            ? (b5.b7(M[L], F), bM[F].push(M[L]))
            : b5.hj(M[L])
            ? (b5.b7(M[L], F), bN[F].push(M[L]))
            : b5.hk(M[L]) && (b5.b7(M[L], F), bQ[F].push(M[L]));
      }
      function y(H, D) {
        var K, J;
        for (J = D; J > D - 6; J--)
      ...
      this.bp = function () {
        ...
        C = as(aZ - B * x, 2);
        E = as(aa - B * A, 2);
        if (fc) for (H = 0; H < cq; H++) (F = H), t(), (fG[F] = 1);
        if (dr.ds && dr.dt.hK)
          for (F = 0; F < b8; F++) {
            if (1 !== fG[F]) {
              if (F < hP) {
    ...
    function iA() {
      ...
      this.iD = function (g) {
        var k =
          8 /
          (1 + Math.pow(2, (this.iB[g].iF - this.iB[1 - g].iF) / 10 / 32));
    ...
    function iL() {
      ...
      this.iZ = function (y) {
        for (
          var n = Array(Math.floor(y.length / 3)), z = 0;
          z < y.length;
          z += 3
        )
      ...
      this.dF = function () {
        ...
        0 !== fG[aw]
          ? ((b0.b1[7] = bU[aw]),
            ...
            eR.cE(),
            eB.j5(),
            eV.gi(d0[aw] - 5, d3[aw] - 5, cz[aw] + 5, d2[aw] + 5),
            eX.bp())
          : eW.show(!1, !1);
        e9.j6(18);
        eA.j7();
    ...
    function jz() {
      function g(L, P, I, O) {
        for (var R, N = 0; N < L.length; N++) {
          ...
          U.fill();
          6 === L[N]
            ? R.drawImage(bw.bz(19), 0, 0)
            : 7 === L[N]
            ? R.drawImage(bw.lB("emojis"), -4 * I, 0)
            : R.drawImage(bw.bz(3), -L[N] * I, 0);
        }
      }
      function k(L) {
        for (var P = K.length - 1; 0 <= P; P--) if (K[P] === L) return !0;
        return !1;
      }
      function t(L) {
        return -1 === L ||
      ...
      function l(L, P) {
        return L < z - A - M ||
          ...
          P > x + 2 * A + M
          ? -1
          : 3 * (P < x - M / 2 ? 0 : P < x + A + M / 2 ? 1 : 2) +
              (L < z - M / 2 ? 0 : L < z + A + M / 2 ? 1 : 2);
      }
      var y = [],
        n,
        z,
      ...
      this.l3 = function () {
        ...
        A = Math.floor((q ? 0.075 : 0.0468) * bq);
        D = A / L;
        M = Math.floor(A / 3);
      ...
      this.c7 = function (L, P) {
        ...
        if (2 === I) {
          if (y[7]) {
            for (I = K.length - 1; 0 <= I; I--)
              0 === fG[K[I]] && K.splice(I, 1);
            0 < K.length &&
              (eQ.lQ(1, K, !0) && (e9.lR(K, G), iu.lS(K, G)), (K = []));
            this.lH();
            return 1;
          }
          return 0;
        ...
        if (3 === I) {
          this.lH();
          if (this.lG(G) && 7 > dv && 1071 > c4.dU()) return e9.lT(), 1;
          e9.lU();
          dx
            ? da(aw, G, as(eR.lV() * ax[aw], 1e3))
            : iu.lW(eR.lV(), G === b8 ? aw : G);
          return 1;
        }
        if (4 === I)
          return (
            y[0]
              ? fc
                ? (this.lH(),
                  dx
                    ? (fd.cQ(0, b5.gF(F), b5.cF(F)), fd.dF())
                    : iu.lY(1e3, b5.gF(F), b5.cF(F)))
                : (this.lH(),
                  e9.lU(),
                  dx
                    ? fM(aw, G, eR.lV())
        ...
        if (5 === I)
          return y[1]
            ? (this.lH(),
              e9.lU(),
              dx
                ? eG.fN(aw, eR.lV(), b5.gF(F), b5.cF(F))
                : iu.lY(eR.lV(), b5.gF(F), b5.cF(F)),
              1)
            : 0;
        if (7 === I && y[4]) return this.lH(), (n = a5.show(L, P)), 1;
        if (8 === I)
          return y[5]
            ? (eQ.lQ(0, [G], !0) && (e9.la(G, 0), iu.lb(G)), this.lH(), 1)
            : 0;
        this.lH();
        return 2;
      };
      this.click = function (L, P) {
        ...
        var I = (q ? 0.0288 : 0.0144) * bq;
        if (
          Math.abs(L - B) > I ||
          Math.abs(P - C) > I ||
          new Date().getTime() > E + 425
        )
          return !1;
        ...
        if (!b5.b6(R)) return !1;
        if (2 === ec)
          return 1 <= a5.lf && ((G = b5.bF(R)), this.lG(G))
            ? (G === aw && this.lH(), (y[4] = !0), this.lg(L, P))
            : !1;
        F = b5.f2(I, O);
      ...
      this.lE = function () {
        var L;
        for (L = y.length - 1; 0 <= L; L--) if (y[L]) return !0;
        return n;
      };
      this.cG = function () {
        this.lE() && this.lq();
      ...
      this.lq = function () {
        if (n) a5.cG();
          ...
          y[0]
            ? fc
              ? cH.drawImage(this.l4[3], 0, 0)
              : cH.drawImage(this.l4[0], 0, 0)
            : y[8]
            ? cH.drawImage(this.l2[0], 0, 0)
            : cH.drawImage(H[0], 0, 0);
    ...
    function k0() {
      function g() {
        ...
        B.setTransform(
          ...
          0,
          C,
          Math.floor((l - C * bw.bz(0).width) / 2),
          Math.floor((l - C * bw.bz(0).height) / 2)
        );
        B.drawImage(bw.bz(0), 0, 0);
        B.setTransform(1, 0, 0, 1, 0, 0);
      }
      function k(B, C) {
        if (!fq.lw) return B <= l + m7 && C >= eR.fL ? 0 : -1;
        if (B <= 4 * l + m7) {
          if (C >= eR.fL) return 0;
      ...
      function t(B, C) {
        ...
        x === B + 1 &&
          C === cK &&
          ((cH.fillStyle = m0), cH.fillRect(0, 0, 4 * l, l));
        cH.fillStyle = C;
        cH.fillRect(0, 0, 4 * l, 1);
        cH.fillRect(0, 0, 1, l);
        cH.fillRect(4 * l, 0, 1, l);
        cH.fillRect(0, l - 1, 4 * l, 1);
        cH.fillText(z[B], 2 * l, 0.54 * l);
      }
      var l,
        y,
        n,
        z = ["Quit Game", "Surrender", "Statistics"],
        x,
        A;
      this.bp = function () {
        x = -1;
      ...
      this.lx = function () {
        ...
        y.width = l;
        y.height = l;
        n = bt + Math.floor((q ? 0.5 : 0.45) * l) + bu;
        g();
      };
      this.m2 = function () {
        (this.lw = !this.lw)
      ...
      this.c7 = function (B, C) {
        ...
        return this.lw
          ? 0 === E
            ...
            ? (this.m2(), 2)
            : 2 === E
            ? (this.fr(aw) && (dx ? eG.fp(aw) : iu.m5(), this.m2()), 2)
            : 3 === E && 2 <= b0.m6
            ? (hy.m2(), (c4.c5 = !0), 2)
            : hy.lE
            ? 1
      ...
      this.cG = function () {
        if (this.lw) {
          ...
          cH.textBaseline = cI;
          cH.textAlign = cJ;
          cH.fillText(z[0], 2 * l, 0.54 * l);
          B = 0.4 * l;
          fq.mB(m7 + 4 * l + (1.5 * l - B) / 2, eR.fL + 0.3 * l, B);
          t(1, fq.fr(aw) ? cK : mD);
          2 <= b0.m6 && t(2, cK);
          cH.setTransform(1, 0, 0, 1, 0, 0);
    ...
    function k1() {
      ...
      function A(I, O, R, N, T, U, Z, Y) {
        var qa = 1e3 <= R;
        var W = Math.floor(
          c2.measureText(O, e9.c0) + 1.5 * D + (qa ? M : 1.5 * D)
        );
        if (W + H > r && !qa && 50 !== R && 20 < O.length) {
          var la = Math.floor(0.5 * O.length);
      ...
      this.bp = function () {
        ...
        10 === dv &&
          A(
            120,
            "Full sending against human players is disabled.",
            6,
            0,
            C(235, 255, 120),
            i1,
      ...
      this.mR = function () {
        ...
        if (dr.ds) {
          ...
          for (I = 0; I < O; I++)
            A(400, dr.dt.mS[I], 6, 0, C(255, 255, 255), i1, -1, !1);
        }
      };
      this.lx = function () {
        var I;
        M = Math.floor((q ? 0.031 : 0.0249) * bq);
        M = 10 > M ? 10 : M;
          ...
          if (((N = R - (T + 1) * M), O >= N && O < N + M)) {
            if (50 === F[T].id) {
              if (I >= gE - K - H - F[T].c1)
                return (
                  I >= gE - K - H
                    ? ((T = F[T].player), this.la(T, 0), iu.lb(T))
                    : eV.gj(F[T].player, 800, !1, 0),
                  !0
                );
              break;
            }
      ...
      this.fl = function (I, O) {
        0 === O
          ...
          : 3 === O
          ? (c2.cQ(I, 2),
            A(0, gM[I] + " won the game.", 0, I, cK, i1, -1, !0),
            eV.gj(I, 2700, !0, 0))
          : 4 === O
          ? (j0--, iz--, this.ml(1, I, I))
          : 5 === O
          ? 2 !== fU[I] &&
            ...
            eA.mn(I)
              ? A(
                  180,
                  gM[I] +
                    " has broken the non-aggression pact and invades you!",
                  1,
                  I,
                  C(255, 200, 180),
                  i1,
          ...
          : 18 === O
          ? A(255, "Choose your start position!", 18, 0, cK, i1, -1, !1)
          : 21 === O
          ? A(220, "You surrendered!", O, 0, "rgb(255,40,40)", i1, -1, !1)
          : 22 === O && this.ml(2, I, I);
      };
      this.mo = function (I) {
        A(200, "Error [" + I + "]", 94, 0, cK, mq, -1, !1);
      };
      this.it = function (I) {
        c2.cQ(I, 2);
        100 > cq
          ? A(0, gM[I] + " won the game.", 3, I, cK, i1, -1, !0)
          : A(0, gM[I] + " has been immortalized!", 3, I, cK, i1, -1, !0);
        eV.gj(I, 2700, !0, 0);
      };
      ...
      this.is = function (I) {
        ...
        I
          ? (9 === dv
              ? ((I = "The Resistance defeated the virus."),
                c2.mz("The Resistance", 2, 1, 12))
              : (I =
                  "Congratulations! Team " +
                  dW.bo[O] +
                  " has won the game!"),
            A(0, I, 40, 0, "rgb(10,220,10)", i1, -1, !1))
          : (9 === dv
              ? ((I = "Mankind lost the war against the virus."),
                c2.mz("The Virus", 2, 0, 16))
              : (I = "Our alliance has been defeated!"),
            A(0, I, 41, 0, "rgb(200,80,80)", i1, -1, !1));
      ...
      this.la = function (I, O) {
        0 === O
          ? E(50, I)
            ? (A(
                128,
                "You signed a non-aggression pact with " + gM[I] + ".",
                52,
                I,
                C(180, 255, 180),
                i1,
            ...
            : A(
                384,
                "You asked " + gM[I] + " to sign a non-aggression pact.",
                51,
                I,
                C(210, 210, 255),
                i1,
          ...
          ? (A(
              128,
              gM[I] + " accepted the non-aggression pact.",
              52,
              I,
              cK,
              "rgba(60,120,10,0.9)",
          ...
          : (A(
              384,
              gM[I] + " requests a non-aggression pact.",
              50,
              I,
              cK,
              "rgba(90,90,90,0.9)",
      ...
      this.lR = function (I, O) {
        ...
        N
          ? ((R += "ordered "), (N = C(255, 235, 210)))
          : ((R += "asked "), (N = C(210, 255, 210)));
        1 < I.length
          ? A(
              230,
              R + I.length + " players to attack " + gM[O] + ".",
              66,
              O,
              N,
              i1,
      ...
      this.n7 = function (I, O) {
        bU[I] > 2 * bU[aw]
          ? A(
              230,
              gM[I] + " orders you to attack " + gM[O] + "!",
              66,
              I,
              cK,
              "rgba(90,50,5,0.9)",
      ...
      this.lU = function () {
        100 <= ax[aw] ||
          A(80, "Your balance is too low!", 9, 0, cK, i1, -1, !1);
      };
      this.lT = function () {
        A(
          80,
          "Boosting is disallowed in the first minute!",
          9,
          0,
          cK,
          i1,
      ...
      this.nC = function (I, O) {
        if (2 !== fU[aw]) {
          ...
          A(
            ...
            O,
            gH,
            R ? "rgba(205,205,205,0.9)" : "rgba(205,255,205,0.9)",
            -1,
            !0
          );
          B(31, q ? 4 : 6);
      ...
      this.dF = function () {
        ...
        for (I = F.length - 1; 0 <= I; I--)
          0 < F[I].gf && ((F[I].gf -= O), 0 >= F[I].gf && F.splice(I, 1));
        if (128 !== L && (L++, !(128 > L)))
          for (I = 5, O = dY - 1; 0 <= O; O--)
            1 === fU[dZ[O]] &&
              0 < I-- &&
              A(
                240,
                gM[dZ[O]] + " joined the game.",
                1,
                dZ[O],
                gH,
      ...
      this.cG = function () {
        for (var I = x(), O, R = F.length - 1; 0 <= R; R--)
          (O = I - (R + 1) * M),
            50 === F[R].id
              ? (cH.drawImage(F[R].ls, gE - F[R].c1 - K - H, O),
                cH.drawImage(P, gE - K - H, O))
              : cH.drawImage(F[R].ls, gE - F[R].c1 - H, O);
      };
    }
    function nU() {
      ...
      this.lx = function () {
        this.c1 = Math.floor(2.8 * Math.floor((q ? 0.09 : 0.062) * bq));
        this.cw = Math.floor(1 * this.c1);
        this.i7 = Math.floor(0.06 * this.c1);
        this.i8 = this.c1 - 2 * this.i7;
        this.nV = this.i7;
        this.nW =
          (this.cw - (this.lt.length + 1) * this.nV) / this.lt.length;
        this.by = Math.floor(0.3 * this.nW);
      };
      ...
      this.nY = function (g, k) {
        ...
        var t = Math.floor(
          (k - 0.5 * this.nV) / ((this.cw - this.nV) / this.lt.length)
        );
      ...
      this.nc = function () {
        ...
        for (var t = this.lt.length - 1; 0 <= t; t--)
          cH.setTransform(
            ...
            1,
            g + this.i7,
            k + this.nV + t * (this.nV + this.nW)
          ),
            (cH.fillStyle = this.colors[t]),
            cH.fillRect(0, 0, this.i8, this.nW),
            this.bs === t &&
              ((cH.fillStyle = nd), cH.fillRect(0, 0, this.i8, this.nW)),
            (cH.fillStyle = cK),
            cH.fillText(this.lt[t], this.i8 / 2, 0.54 * this.nW),
    ...
    function k2() {
      ...
      this.lx = function () {
        y = Math.floor((q ? 0.53 : 0.36) * bq);
        n = Math.floor(0.065 * y);
        z = bt + Math.floor(0.9 * n) + bu;
        l--;
        this.setTime();
      };
      this.dF = function () {
      ...
      this.cG = function () {
        ...
        cH.translate(gE - n, Math.floor(0.5 * (cB + y)));
        cH.rotate(-Math.PI / 2);
        cH.fillStyle = cK;
        cH.fillRect(0, 0, y, n);
        cH.strokeStyle = gH;
        ...
        cH.textBaseline = cI;
        cH.textAlign = cJ;
        cH.fillText(k, Math.floor(y / 2), Math.floor(0.59 * n));
        cH.setTransform(1, 0, 0, 1, 0, 0);
      };
    }
    function nm() {
      ...
      this.bp = function () {
        ...
        k = bw.lB("flags");
        for (g = 0; g < this.np; g++) this.o2(g, this.no + g, k);
        this.o4();
      ...
      this.o2 = function (g, k, t) {
        ...
        l.width = this.c1;
        l.height = this.c1;
        var y = l.getContext("2d", { alpha: !0 });
        y.clearRect(0, 0, this.c1, this.c1);
        23 === k
          ? y.drawImage(hx.l5[2], 0, 0)
          : 36 === k
          ? y.drawImage(hx.l5[0], 0, 0)
          : 49 === k
          ? y.drawImage(hx.l5[1], 0, 0)
          : y.drawImage(
              t,
              (this.c1 * g) % (g === k ? this.nn * this.c1 : 4e3),
              g === k ? as(g, this.nn) * this.c1 : 0,
              this.c1,
              this.c1,
              0,
              0,
      ...
      this.o1 = function () {
        this.ns = Math.floor((q ? 0.075 : 0.0468) * bq);
    ...
    var gH = "rgb(0,0,0)",
      ...
      p0 = [
        "https://territorial.io/players",
        "https://territorial.io/clans",
      ],
      m7,
      p1,
      cA,
    ...
    function p8() {
      cA = Math.floor((q ? 0.02 : 0.01152) * bq);
      cA = 2 > cA ? 2 : cA;
      m7 = Math.floor((q ? 0.0114 : 0.01296) * bq);
      m7 = 2 > m7 ? 2 : m7;
      p1 = Math.floor(0.005 * pO);
      p1 = 1 > p1 ? 1 : p1;
    }
    function pC(g) {
      g.preventDefault();
    ...
    function pI(g) {
      ...
      p3 = !0;
      0 < g.touches.length &&
        ((p4 = Math.floor(pS * g.touches[0].clientX)),
    ...
    function pR(g, k) {
      if (0 === ec) aJ.c7(g, k);
        ...
        !(hy.c7(g, k) || hx.lD(g, k) || eW.c7(g, k) || eP.c7(g, k))
      ) {
        var t = fq.c7(g, k);
        2 === t ||
          eM.c7(g, k) ||
          (gm.c7(g, k)
            ? (c4.c5 = !0)
            : eR.pV(g, k)
            ? ((gm.gn = !1), eR.pW(g, k) && (c4.c5 = !0))
            : e9.c7(g, k) || eS.c7(g, k) || (0 === t && hx.lF(g, k)));
      }
    }
    function pD(g) {
      p3 = !1;
        ...
        : hy.lo(g, k) ||
          (hx.lE()
            ...
            : fq.lo(g, k) ||
              (eR.pZ
                ? eR.lo(g, k) && (c4.c5 = !0)
                : (eM.lo(g, k), gm.gn && gm.lo(g, k) && (c4.c5 = !0))));
    }
    function pG(g) {
      g.preventDefault();
      0 === ec
        ? (aJ.click(-1024, -1024), jj.pa())
        : (eM.pb(-1024, -1024),
          fq.lo(-1024, -1024),
          eR.pc(),
          gm.gn && (gm.gn = !1));
    ...
    function pK(g) {
      g.preventDefault();
      g && g.touches && 0 < g.touches.length && 0 !== ec
        ? (gm.gn = !1)
        : pd(p4, p5);
    }
    function pL(g) {
    ...
    function k3() {
      function g(C) {
        ...
        0 === n[C].id
          ? (k(C, E),
            ...
            (E -= A),
            n[C].i0.beginPath(),
            n[C].i0.moveTo(Math.floor(0.3 * A + E), Math.floor(A / 2)),
            n[C].i0.lineTo(Math.floor(A - 0.3 * A + E), Math.floor(A / 2)),
            n[C].i0.stroke(),
            n[C].i0.beginPath(),
            n[C].i0.moveTo(Math.floor(A / 2 + E), Math.floor(0.3 * A)),
            n[C].i0.lineTo(Math.floor(A / 2 + E), Math.floor(A - 0.3 * A)),
            n[C].i0.stroke())
          : k(C, 2 * A);
      }
      function k(C, E) {
        ...
        E = A + 1;
        n[C].i0.beginPath();
        n[C].i0.moveTo(Math.floor(E - 0.35 * A), Math.floor(0.35 * A));
        n[C].i0.lineTo(
          Math.floor(E - A + 0.35 * A),
          Math.floor(A - 0.35 * A)
        );
        n[C].i0.stroke();
        n[C].i0.beginPath();
        n[C].i0.moveTo(Math.floor(E - A + 0.35 * A), Math.floor(0.35 * A));
        n[C].i0.lineTo(Math.floor(E - 0.35 * A), Math.floor(A - 0.35 * A));
        n[C].i0.stroke();
      }
      function t(C) {
        ...
        C.cM < b8 &&
          0 === C.id &&
          (E += Math.floor(pp.measureText(gM[C.cM] + "000").width));
        E += A;
        0 === C.id && (E += A);
        C.ls.width = E;
        C.ls.height = A;
        C.i0 = C.ls.getContext("2d", { alpha: !0 });
        C.i0.font = x;
      ...
      function y(C) {
        return Math.floor(
          2 * m7 + (eO.qJ() ? eB.cw + m7 : 0) + eO.cw + 1.3 * C * A
        );
      }
      var n, z, x, A, B;
      this.bp = function () {
      ...
      this.lx = function () {
        ...
        for (var C = n.length - 1; 0 <= C; C--) t(n[C]), g(C);
      };
      this.eb = function () {
      ...
      this.gL = function (C) {
        ...
        var E = Math.floor(Math.log(C + 0.5) / Math.log(10)) + 1,
          G = Math.floor((E - 1) / 3);
        C = C.toString();
          ...
          if (E >= D - M && E <= D + A + M) {
            ...
            if (0 === n[G].id && C >= H + K - A - F && C <= H + K + F)
              return (
                dx
                  ? fM(aw, n[G].cM, eR.lV())
                  : iu.lW(eR.lV(), n[G].cM === b8 ? aw : n[G].cM),
                !0
              );
          }
        }
      ...
      this.dF = function () {
        if (2 !== ec && 0 !== fG[aw] && !jB && hx.lG(aw)) {
          ...
          b: if (n.length !== C) var E = !0;
            ...
            for (E = C - 1; 0 <= E; E--)
              if (n[E].id !== ae.ag(aw, E) || n[E].cM !== ae.al(aw, E)) {
                E = !0;
                break b;
              }
            E = !1;
    ...
    function k4() {
      ...
      function k() {
        ...
        D.fillText(
          E[l[0].qU],
          Math.floor(l[0].width / 2),
          Math.floor(0.72 * C[0] * x)
        );
        D.font = A[1];
        D.fillText(
          l[0].l,
          Math.floor(l[0].width / 2),
          Math.floor((C[0] + 0.48 * C[1]) * x)
        );
      }
      function t() {
        D.beginPath();
      ...
      this.lx = function () {
        var L;
        x = Math.floor((q ? 0.0725 : 0.058) * bq);
        B[0] = Math.floor(0.85 * C[0] * x);
        B[1] = Math.floor(0.85 * C[1] * x);
        A[0] = bt + B[0] + bu;
        A[1] = bt + B[1] + bu;
        for (L = G.length - 1; 0 <= L; L--)
          G[L] = this.measureText(E[L] + "000", A[0]);
        F = Math.floor(1 + 0.05 * x);
        M = Math.floor(0.2 * x);
        if (0 < l.length) {
      ...
      this.dF = function () {
        if (0 !== y)
          if (4 === y)
            c4.gf > J && ((y = 0), 1 === ec && c2.mz(jp.nF(), 3, 1, 9));
          else {
            if (1 === y)
              0 === n && (k(), (n = 1e-4)),
                (n += 0.002 * (c4.gf - K)),
              ...
              3 === y &&
                ((n -= 0.002 * (c4.gf - K)),
                0 >= n && ((n = 0), l.shift(), (y = 0 < l.length ? 1 : 0)),
                (c4.c5 = !0));
            K = c4.gf;
          }
      };
      ...
      this.mz = function (L, P, I, O) {
        ...
        R = R < G[P] ? G[P] : R;
        l.push({ l: L, width: R, qU: P, qV: I, ge: O });
        0 === y && ((n = 0), (y = 1), (K = c4.gf));
      };
      this.cG = function () {
        0 !== y &&
          0 !== n &&
          (1 > n ? ((cH.globalAlpha = n), g(), (cH.globalAlpha = 1)) : g());
      };
    }
    function ki() {
      function g() {
        ...
        1 === x
          ? ((n.fillStyle = oR), n.fillRect(K, 0, K, l))
          : -1 === x && ((n.fillStyle = oZ), n.fillRect(0, 0, K, l));
        i2(n, D, l, 2);
        K = Math.floor(0.25 * l);
        K = 2 > K ? 2 : K;
        n.fillStyle = ol;
        ...
        K = Math.floor(l / 8);
        K = 2 > K ? 2 : K;
        i4(n, Math.floor(0.4 * l), 0, l, K, 0.5, !1);
        i4(n, Math.floor(D - 1.4 * l), 0, l, K, 0.5, !0);
      ...
      this.qj = function () {
        ...
        if (void 0 === z || z.width !== D) {
          ...
          K.lineTo(L, L + D);
          K.moveTo(
            L + Math.cos(0.78 * Math.PI) * D,
            L + Math.cos(0.28 * Math.PI) * D
          );
          K.lineTo(L, L);
          K.lineTo(
            L + Math.cos(0.22 * Math.PI) * D,
            L + Math.cos(1.72 * Math.PI) * D
          );
          K.stroke();
        }
      };
        ...
        if (0 < H) H--, 0 === H && k();
          ...
          if (D) {
            ...
            dA &&
              9 !== dv &&
              (B[0] = qr(
                me(as(K * (100 - as(100 * eT.qs(), jC)), 100), 1),
                B[0]
              ));
            B[1] = me(K - B[0], 1);
            M++;
      ...
      this.fY = function (D, K) {
        var J;
        if (this.lE) {
          for (J = C.length - 1; 0 <= J; J--) if (C[J] === D) return;
          C.push(D);
          E = !0;
          J = dx ? B[0] : bU[D];
          K ? (A[0] += J) : (A[1] += J);
    ...
    function k5() {
      ...
      function k() {
        ...
        H = 1 + Math.floor(0.0625 * eR.cw);
        var D = 1 + Math.floor(0.3 * eR.cw);
        A.fillRect(
          Math.floor(0.25 * eR.cw) + D,
          Math.floor((eR.cw - H) / 2),
          eR.cw - 2 * D,
          H
        );
        A.fillRect(
          Math.floor(y - 1.25 * eR.cw) + D,
          Math.floor((eR.cw - H) / 2),
          eR.cw - 2 * D - (D % 2),
          H
        );
        A.fillRect(
          Math.floor(y - 1.25 * eR.cw) + Math.floor((eR.cw - H) / 2),
          D,
          H,
          eR.cw - 2 * D - (D % 2)
        );
        E = Math.floor(ax[aw] * C);
        A.fillText(eP.gL(E), Math.floor(y / 2), Math.floor(0.55 * eR.cw));
      }
      function t(H) {
        if (1 < H && 0 === C) return (C = 0.01), k(), !0;
        if ((1 < H && 1 === C) || 0 === C) return !1;
        C *= H;
        C = 1 < C ? 1 : 0 > C ? 0 : C;
        k();
        return !0;
      ...
      this.lx = function () {
        q && r < 0.8 * s
          ? ((this.cw = Math.floor(0.0536 * bq)),
            (y = r - 4 * m7 - this.cw))
          : ((y = Math.floor((q ? 0.65 : 0.389) * bq)),
            (y += 12 - (y % 12)),
            (this.cw = Math.floor(y / 12)));
        z = Math.floor((3 * this.cw) / 2);
        G = bt + Math.floor(0.5 * this.cw) + bu;
        x = document.createElement("canvas");
        x.width = y;
        x.height = this.cw;
        A = x.getContext("2d", { alpha: !0 });
        A.font = G;
        A.textBaseline = cI;
        A.textAlign = cJ;
        this.qy();
      ...
      this.qy = function () {
        n = q && r < 0.8 * s ? this.cw + 3 * m7 : Math.floor((gE - y) / 2);
      ...
      this.ph = function (H) {
        ...
        0 < H
          ? ((H = 400 / (400 + H)), (H = H < M ? M : H))
          : ((H = (400 - H) / 400), (H = H > 1 / M ? 1 / M : H));
        return t(H);
      };
    ...
    function k6() {
      ...
      this.lx = function () {
        t = Math.floor((q ? 0.072 : 0.0502) * bq);
        t = 8 > t ? 8 : t;
        for (var x = 1; 0 <= x; x--)
          (g[x] = document.createElement("canvas")),
            (g[x].width = t),
            (g[x].height = t),
            (k[x] = g[x].getContext("2d", { alpha: !0 }));
        this.qy();
        x = Math.floor(1 + t / 20);
        for (var A = 1; 0 <= A; A--)
      ...
      this.c7 = function (x, A) {
        if (
          (Math.pow(x - (l + t / 2), 2) + Math.pow(A - (y + t / 2), 2) <
            (t * t) / 4 ||
            Math.pow(x - (l + t / 2), 2) + Math.pow(A - (y + 2 * t), 2) <
              (t * t) / 4) &&
          !gI.gJ.rM
        )
          return A < y + 1.25 * t
            ? this.ph(Math.floor(gE / 2), Math.floor(cB / 2), -200)
            : this.ph(Math.floor(gE / 2), Math.floor(cB / 2), 200);
        eV.h3() && ((this.gn = !0), (n = x), (z = A));
        return !1;
      };
      ...
      this.ph = function (x, A, B) {
        if (!eV.h3()) return !0;
        if (0 < B) (B = 450 / (450 + B)), (B = 0.5 > B ? 0.5 : B);
      ...
      this.cG = function () {
        gI.gJ.rM ||
          (cH.drawImage(g[0], l, y),
          cH.drawImage(g[1], l, Math.floor(y + (3 * t) / 2)));
      };
    }
    function k7() {
      function g() {
        A = Math.floor(0.2 * (q ? 0.07 : 0.035) * bq);
        A = me(q ? 3 : 1, A);
        var N = r / (n.length + B);
        A = N > A ? N : A;
        P = Math.floor((1 - B) * A);
      ...
      function k() {
        ...
        C = x / n[N];
        for (var T = G - 1; T >= E; T--)
          n[T] > n[N] && ((N = T), (C = x / Math.pow(n[T], L)));
      }
      function t(N) {
      ...
      this.bp = function () {
        ...
        B = 0.3;
        R = [];
        R.push({ mv: "Plateau A", b3: 0, pP: 57 });
        R.push({ mv: "Max A", b3: 1, pP: 1 });
        R.push({ mv: "Black Friday", b3: 15, pP: 15 });
        R.push({ mv: "Max B", b3: 19, pP: 19 });
        R.push({ mv: "Max C", b3: 44, pP: 44 });
        R.push({ mv: "First Android Version", b3: 58, pP: 58 });
        R.push({ mv: "Max D", b3: 67, pP: 67 });
        R.push({ mv: "The iFrame Explosion", b3: 98, pP: 99 });
        R.push({ mv: "The 155-Day Uptrend", b3: 58, pP: 213 });
        R.push({ mv: "Max E", b3: 213, pP: 213 });
        R.push({ mv: "Plateau B", b3: 214, pP: 259 });
        R.push({ mv: "Turbulent Times", b3: 260, pP: 344 });
        R.push({ mv: "Max F", b3: 262, pP: 262 });
        R.push({ mv: "Max G", b3: 282, pP: 282 });
        R.push({ mv: "Max H", b3: 333, pP: 333 });
        R.push({ mv: "The 19-Day Downtrend", b3: 283, pP: 301 });
        R.push({ mv: "Plateau C", b3: 345, pP: 385 });
        R.push({ mv: "The Alliance Ascent", b3: 386, pP: 395 });
        R.push({ mv: "Max I", b3: 395, pP: 395 });
        R.push({ mv: "First iOS Version", b3: 411, pP: 411 });
        R.push({ mv: "Plateau D", b3: 396, pP: 453 });
        R.push({ mv: "The TikTok Revolution", b3: 454, pP: 470 });
        R.push({ mv: "Max J", b3: 456, pP: 456 });
        R.push({ mv: "Max K", b3: 472, pP: 472 });
        R.push({ mv: "Max L", b3: 478, pP: 478 });
        R.push({ mv: "YT Drew", b3: 471, pP: 485 });
        R.push({ mv: "Plateau E", b3: 485, pP: 600 });
        R.push({ mv: "Uptrend A", b3: 600, pP: 613 });
        R.push({ mv: "Max M", b3: 613, pP: 613 });
        R.push({ mv: "Downtrend A", b3: 614, pP: 635 });
        R.push({ mv: "Plateau F", b3: 636, pP: 737 });
        R.push({ mv: "End of Record", b3: 738, pP: 738 });
        n = [
          208644377, 208644377, 208644377, 206964709, 205156594, 250680803,
          249089835, 234476552, 252346209, 263196406, 270821533, 291436400,
          294907103, 288866179, 297960890, 310165928, 323215738, 326005712,
          312078872, 282668674, 268883231, 261100885, 247870209, 240175828,
          231697235, 240614202, 237647174, 230525212, 228239099, 226070733,
          215992739, 216961676, 231079584, 235793502, 234032821, 228402462,
          216942832, 211862670, 209792418, 220626495, 221020535, 228198633,
          226910806, 227687295, 210969547, 197393506, 205629061, 215820135,
          213694935, 209455870, 215822584, 215130299, 214034219, 229190414,
          230055290, 225313791, 223398523, 231870169, 226224938, 218242706,
          235891029, 210498444, 195329116, 187676007, 183432634, 175752106,
          170096205, 173369342, 171454357, 185810310, 189616577, 190788861,
          179291487, 179513980, 189122353, 188375572, 202060722, 203256609,
          197948652, 191950448, 194693217, 196335490, 195911919, 202264283,
          199251620, 193699336, 188441210, 183419345, 195919988, 198126823,
          199780788, 197440550, 190144884, 179139362, 166469099, 178827877,
          183801980, 197952484, 188875861, 185919783, 186237411, 182504952,
          183532013, 174109004, 178159701, 161031347, 194622838, 205645645,
          200496457, 194773327, 194546481, 207893217, 210920126, 213376144,
          173859897, 154326886, 158943729, 166772975, 175066046, 177406405,
          179018562, 185986119, 186747583, 200787939, 208959937, 161987576,
          185512400, 185788899, 185957487, 194591063, 215634157, 230579314,
          237637383, 240518707, 221398239, 225230795, 224891285, 211292916,
          216944626, 219436299, 226523918, 232405568, 232166426, 216921782,
          244767964, 257278946, 243548100, 237386943, 242802627, 229717622,
          168149709, 259971896, 267057767, 257606635, 209857364, 126035568,
          129833237, 151312703, 197006695, 73120657, 37551024, 39229432,
          29517736, 29382631, 31512045, 42652097, 47363019, 49624906,
          46687310, 33767120, 31230439, 34211643, 43094531, 53747053,
          55380682, 49779117, 47748833, 21038802, 20406484, 24523793,
          26566139, 25284142, 26825553, 23497443, 20291865, 17765022,
          21291320, 21106123, 19050128, 18324426, 19044067, 19594721,
          19347845, 23365124, 24186529, 19824881, 17952812, 17093838,
          17328579, 17607296, 21284737, 22551012, 20471281, 19350848,
          19654931, 18725460, 18641926, 23301269, 25178902, 21617041,
          21433781, 21078957, 19526047, 18665064, 21394401, 21575049,
          19286677, 18018450, 17550775, 17282428, 17055509, 19348704,
          20177845, 19766211, 19088037, 18118802, 18269428, 18500614,
          19130220, 19351798, 19205188, 19489961, 20233286, 20726811,
          23245145, 26158741, 26096642, 24424181, 23690661, 22967492,
          21098008, 20325973, 19431907, 17008295, 15583096, 14209752,
          14307184, 13541498, 12822679, 13154311, 12161194, 12956543,
          11435697, 13428928, 12262514, 12858519, 12405344, 12884309,
          14410011, 15556681, 15260178, 14863807, 13861458, 15176144,
          14089849, 13063987, 12378716, 13061867, 13118900, 13112653,
          13137263, 13062253, 13126875, 14136833, 14711852, 14341250,
          11888270, 13137006, 12830841, 12516937, 12783789, 13139393,
          12931e3, 12857582, 13677329, 13892963, 13171528, 14135236,
          14640750, 15677970, 16758399, 19125177, 17723446, 16469484,
          17032884, 19792603, 21426397, 22032534, 20271251, 16190176,
          16772813, 17675977, 18764026, 18346209, 19576834, 20989792,
          21350839, 14696885, 14653075, 14677999, 14958759, 14210260,
          15488352, 15623604, 14473144, 12823062, 14869909, 15142264,
          15567014, 17896725, 20081347, 17765006, 12763925, 13523610,
          13979983, 15080856, 17116394, 18483238, 18084320, 12100282,
          12221529, 12441579, 12058220, 12441689, 12821546, 13401583,
          13009895, 12271066, 12210094, 12355642, 13737115, 14257807,
          14904897, 14072161, 15640387, 15721803, 16397970, 19254839,
          21608906, 20527471, 16596206, 15550563, 14385591, 15547262,
          13174302, 12462319, 13000669, 12832541, 12186376, 13150940,
          14654379, 14299386, 14158528, 15185971, 12444117, 14253445,
          15049053, 14123310, 16892853, 15963931, 11858727, 10012703,
          9478191, 9193460, 8851082, 9298848, 9638204, 9442496, 8653593,
          9093527, 8530977, 8809114, 9609612, 9906912, 9615756, 9477879,
          9713075, 9126583, 8949378, 9577595, 10180186, 9858705, 9534213,
          9184660, 8889455, 8311313, 9738346, 9772164, 9157791, 8445413,
          8467279, 8756002, 9257951, 10213536, 10620530, 10352296, 9350531,
          9118709, 9614237, 9692491, 10801215, 10984804, 9542309, 9609538,
          9391430, 9515517, 10064494, 11061684, 10408005, 9794768, 9297643,
          9275992, 9394076, 9716084, 10045958, 9715229, 9091248, 10010584,
          9845528, 9532588, 8986320, 9037708, 9820996, 8953464, 9074064,
          8644692, 8025308, 8832112, 10785788, 10539708, 8908744, 8331216,
          8858100, 8626840, 7666284, 8503372, 8855308, 6762540, 6414076,
          6786692, 6445532, 6262192, 5918176, 5864376, 5464928, 5384996,
          5942760, 5261972, 5404612, 6184860, 6312948, 5815660, 5208552,
          4734392, 4538784, 4661404, 5145524, 4819368, 4369224, 4458584,
          4289956, 3538288, 3517544, 3871876, 3388048, 3344796, 3089228,
          2863676, 2268964, 2160500, 2580004, 2244356, 2018408, 1688912,
          1945368, 1796332, 1619260, 2060292, 1597656, 1472788, 1306208,
          1171408, 1021096, 1109312, 1241276, 1305092, 1142748, 1157700,
          991984, 786992, 786396, 1043956, 1029320, 860500, 834824, 841912,
          736464, 690328, 878376, 907232, 794932, 646388, 752600, 672836,
          636212, 794108, 746856, 642928, 671328, 493568, 458168, 428776,
          464736, 371412, 314568, 225472, 252072, 227604, 251048, 269184,
          174136, 825576, 536060, 165952, 153252, 180036, 149616, 138472,
          157832, 188152, 180108, 134076, 70960, 89236, 111428, 60520,
          74620, 73424, 74720, 71584, 94432, 62572, 66420, 32532, 34452,
          41048, 51372, 61916, 43236, 55172, 26776, 47e3, 57424, 93100,
          64980, 37288, 44296, 34588, 40700, 29200, 24604, 18184, 42660,
          31404, 38096, 18556, 17388, 19568, 17604, 22328, 40300, 39392,
          33440, 17960, 7984, 11612, 67700, 14108, 22444, 19756, 9436,
          16864, 14400, 17216, 14436, 8612, 15952, 29764, 18748, 16348,
          23976, 22080, 20268, 20984, 9480, 30736, 15996, 9484, 9392, 9716,
          21540, 57428, 24788, 18728, 8528, 5972, 20560, 18268, 28088,
          15364, 15300, 29348, 30992, 20564, 34420, 16716, 14424, 12360,
          15124, 51172, 13176,
        ];
        this.lx();
        eD.rp(0, 0);
      ...
      this.lx = function () {
        x = Math.floor(0.15 * s);
        M = Math.floor((q ? 0.018 : 0.0137) * bq);
        M = 10 > M ? 10 : M;
        H = bt + M + bu;
        g();
      };
      ...
      this.cG = function () {
        ...
        J && 0 === E && ((cH.fillStyle = oZ), l(0));
        -1 !== F && ((cH.fillStyle = oi), l(F));
        if (-1 !== F) {
          cH.font = H;
          cH.textBaseline = oo;
          N = new Date();
          ...
          cH.fillStyle = cK;
          cH.textAlign = op;
          cH.fillText(Z, Math.floor(gE - 0.5 * M), ca);
          Z = ca - 2 * la;
          Y = -1;
          qa = n.length - F - 1;
          for (W = R.length - 1; 0 <= W; W--)
            qa >= R[W].b3 &&
              qa <= R[W].pP &&
              (-1 === Y || R[W].pP - R[W].b3 < R[Y].pP - R[Y].b3) &&
              (Y = W);
          -1 !== Y &&
            ((qa = Math.floor(cH.measureText(R[Y].mv).width)),
            (cH.fillStyle = i1),
            cH.fillRect(gE - qa - M, Z, qa + M, la),
            (cH.fillStyle = cK),
            cH.fillText(R[Y].mv, Math.floor(gE - 0.5 * M), Z + la));
          cH.textAlign = cJ;
          cH.fillText(N, T, cB);
          cH.strokeStyle = nd;
          cH.lineWidth = 1;
    ...
    function k8() {
      ...
      this.lx = function () {
        k = Math.floor((q ? 0.305 : 0.24) * bq);
        this.cw = Math.floor(0.5 + 0.13 * k);
        k = Math.floor(6 * this.cw);
        g = bt + Math.floor(0.8 * this.cw) + bu;
        G = Math.floor(0.5 * this.cw);
        pp.font = g;
        t = m7;
        l = Math.floor(1 + 0.13 * this.cw);
        n = document.createElement("canvas");
        n.width = k;
        n.height = this.cw;
        z = n.getContext("2d", { alpha: !0 });
        z.font = g;
        z.textBaseline = cI;
        z.textAlign = cJ;
        this.sI();
      ...
      this.qy = function () {
        this.qJ()
          ? (this.fK = gE - k - m7)
          : (this.fK = Math.floor(
              eM.sJ() + (gE - eM.sJ() - eB.c1 - k) / 2 - 0.5 * m7
            ));
      };
      this.eb = function () {
        x && ((x = !1), this.sI());
    ...
    function k9() {
      function g() {
        ...
        B.font = sP;
        B.textAlign = mj;
        for (S = x - V; 0 <= S; S--) k(en[S + Y]), l(S, S + Y, en[S + Y]);
        B.textAlign = op;
        ...
        2 === V &&
          ...
          y(x - 1, aw));
        0 === Y &&
          ((S = (0.7 * H) / bw.bz(4).height),
          B.setTransform(
            S,
            0,
            0,
            S,
            Math.floor(D + 0.58 * H + 0.5 * S * bw.bz(4).width),
            Math.floor(G + sQ + 0.4 * H)
          ),
          (B.imageSmoothingEnabled = !0),
          B.drawImage(
            bw.bz(4),
            -Math.floor(bw.bz(4).width / 2),
            -Math.floor(bw.bz(4).height / 2)
          ),
          B.setTransform(1, 0, 0, 1, 0, 0));
      }
      function k(S) {
      ...
      function t(S, V) {
        ...
        ba =
          S === x - 2
            ? Math.floor(M + 9.15 * H) - Math.floor(M + 8.15 * H)
            : ba;
        B.fillRect(
          0,
          Math.floor(M + (S + (0 === S ? 0 : 0.15)) * H),
          sN,
          ba
        );
      }
      function l(S, V, ba) {
        B.fillText(R[V], D, Math.floor(G + sQ + (S + 0.5) * H));
        1 === fU[ba] && (B.font = oq + sP);
        B.fillText(
          P[ba] === ba ? gM[ba] : L[P[ba] % b8],
          K,
          Math.floor(G + sQ + (S + 0.5) * H)
        );
        0 !== fU[ba] && (B.font = sP);
      }
      function y(S, V) {
        B.fillText(bU[V], J, Math.floor(G + sQ + (S + 0.5) * H));
      }
      function n(S) {
        S -= m7 + M;
        if (0 > S) return Math.floor(S / H) - 1;
        if (S < (x - 1) * H) return Math.floor(S / H);
        if (S < qY - M) return x - 1;
        S -= qY - M;
      ...
      this.st = function (S) {
        ...
        ta += "...]";
        P[S] === S
          ? ((P[S] = b8 + L.length), L.push(ta))
          : (L[P[S] % b8] = ta);
        return ta;
      };
      this.lx = function (S) {
        q
          ? ((sN = Math.floor(0.335 * bq)), (qY = Math.floor((x * sN) / 8)))
          : ((sN = Math.floor(0.27 * bq)),
            (qY = Math.floor((x * sN) / 10)));
        sN = Math.floor(0.97 * sN);
        A = document.createElement("canvas");
        A.width = sN;
        A.height = qY;
        B = A.getContext("2d", { alpha: !0 });
        G = 0.025 * sN;
        sQ = 0.16 * sN;
        F = 0 * sN;
        M = Math.floor(0.45 * G + sQ);
        H = (qY - sQ - 2 * G - F) / x;
        sO = bt + Math.floor(0.55 * sQ) + bu;
        sP = Math.floor((q ? 0.67 : 0.72) * H) + bu;
        B.font = sP;
        D = Math.floor(0.04 * sN);
        K = Math.floor((q ? 0.195 : 0.18) * sN);
        ...
        if (!S) {
          ...
          for (S = b8 - 1; 0 <= S; S--)
            I[S] = Math.floor(
              B.measureText(P[S] === S ? gM[S] : L[P[S] % b8]).width
            );
          g();
        }
      };
    ...
    function kA() {
      function g() {
        ...
        z.fillRect(
          0,
          eB.cw - B - 1,
          Math.floor((0 < P ? P : Math.sqrt(K[4] / K[3])) * eB.c1),
          B
        );
        z.fillStyle = cK;
        ...
        for (var N = 0, T = 0; T < D.length; T++)
          if (J[T]) {
            z.textAlign = mj;
            var U = Math.floor(
              ((C - B + 2 * G) * (T - N + 1)) / (D.length + 1) - 0.7 * G
            );
            z.fillText(D[T], E, U);
            z.textAlign = op;
            5 === T && 0 !== fG[aw] && ax[aw] >= ay.dJ(aw)
              ? ((z.fillStyle = om),
      ...
      this.lx = function () {
        ...
        B = Math.floor(0.04 * this.c1);
        E = Math.floor(0.05 * this.c1);
        G = 0.04 * this.c1;
        C = this.cw;
        this.cw -= Math.floor((O * (this.cw - 2 * B)) / D.length);
        M = Math.floor((0.55 * (C - B)) / D.length);
        F = bt + M + bu;
        n = document.createElement("canvas");
        n.width = this.c1;
        n.height = this.cw;
      ...
      this.j5 = function () {
        A = m7 + (eO.qJ() && 0 !== fG[aw] && !fc ? eO.cw + m7 : 0);
      };
      this.eb = function (N) {
    ...
    function kB() {
      ...
      this.lx = function () {
        if (g) {
          t = q ? Math.floor(0.69 * bq) : Math.floor(0.5 * bq);
          t = qr(t, me(r - 2 * m7, 10));
    ...
    function kf() {
      function g(n, z, x, A, B, C, E) {
        0 !== fG[n] &&
          0 !== bU[n] &&
          ((x = (gE * ((d0[n] + cz[n] + 1) / 2 - x)) / (B - x) - 0.5 * z),
          (A = (cB * ((d3[n] + d2[n] + 1) / 2 - A)) / (C - A) - 0.5 * z),
          x > gE ||
            A > cB ||
            x < -z ||
            A < -z ||
            (cH.setTransform(g7 * E, 0, 0, g7 * E, x, A),
            cH.drawImage(t[dA ? dW.dX[n] : n < cq ? 1 : 0], 0, 0)));
      }
      var k, t, l, y;
      this.bp = function () {
        var n;
    ...
    function da(g, k, t) {
      if (
        ...
        0 >= y ||
          ((t = t > y ? y : t),
          g === aw && (e9.nA(t, k), (b0.b1[12] += l), (b0.b1[16] += t)),
          k === aw && (e9.nC(t, g), (b0.b1[10] += t)),
          (ax[g] -= t + l),
          (ax[k] += t));
      }
    }
      ...
      this.u5 = function () {
        ...
        if (this.hC || (this.u3 && this.j8)) {
          ...
          l === this.u4[3]
            ...
            : t >= g &&
              l >= k &&
              jZ.putImageData(ja, 0, 0, g, k, t - g + 1, l - k + 1);
        }
      };
      this.j9 = function () {
        this.j8 &&
          ...
          jZ.putImageData(
            ...
            this.u4[0],
            this.u4[1],
            this.u4[2] - this.u4[0] + 1,
            this.u4[3] - this.u4[1] + 1
          );
        this.j8 = !1;
      };
      this.j2 = function () {
    ...
    function u8() {
      ...
      this.lx = function () {
        var l;
        this.c1 = this.uQ(q ? 0.85 : 0.66, 0.75, r, s);
        this.cw = Math.floor(this.c1 / 0.75);
        for (l = 1; 0 <= l; l--)
          this.mE[l] &&
            (this.mE[l][4] =
              bt + Math.floor((this.mE[l][5] * this.cw) / 10) + bu);
        k = bt + Math.floor(0.1 * this.cw) + bu;
      };
        ...
        if (this.mE && this.mE[l]) {
          ...
          if (0 === l) {
            for (x = 0; x < this.mE[l][0].length; x++)
              if (
                y === this.mE[l][0][x].name &&
                n > 0.99 * this.mE[l][0][x].value &&
                n < 1.01 * this.mE[l][0][x].value
              ) {
                this.mE[l][0][x].value = z;
                A = !0;
                break;
              }
            A || this.mE[l][0].push({ name: y, value: z });
          } else {
            for (x = 0; x < this.mE[l][0].length; x++)
              if (y === this.mE[l][0][x].name) {
                this.mE[l][0][x].value +=
                  32 < this.mE[l][0][x].value
                    ? (64 - this.mE[l][0][x].value) / 256
                    : 0.25;
            ...
            A || this.mE[l][0].push({ name: y, value: 0.25 });
          }
          this.uX(l);
        }
      };
      this.uW = function (l, y, n) {
        for (var z = l.length - 1; 0 <= z; z--)
          for (; 3 < l[z].name.length && c2.measureText(l[z].name, y) > n; )
            l[z].name =
              l[z].name.substring(0, l[z].name.length - 4) + "...";
      };
      this.c7 = function (l, y) {
        ...
        if (0 > l || l > this.c1 || 0 > y || y > this.cw)
          return (
            (this.lE = !1), 0 === aJ.pe() && jn.cE(0, !0), (c4.c5 = !0)
          );
        if (y < 0.3 * this.cw) var n = 1;
        else
          y < 0.85 * this.cw
            ? ((n =
                ((0 === this.u9 ? 14.1 : 3) * (y - 0.3 * this.cw)) /
                (0.55 * this.cw)),
              (n = Math.floor(1 + n * n)))
            : (n = 0 === this.u9 ? 200 : 10);
      ...
      this.cG = function () {
        if (this.lE) {
          ...
          cH.fillText(
            g[this.u9],
            Math.floor(this.c1 / 2),
            Math.floor(0.135 * this.cw)
          );
          cH.font = bt + Math.floor(0.025 * this.cw) + bu;
          cH.fillText(
            g[this.u9 + 2],
            Math.floor(this.c1 / 2),
            Math.floor(0.2125 * this.cw)
          );
          cH.beginPath();
      ...
      this.ug = function (l) {
        var y = me(2, Math.floor(0.06 * this.c1));
        y -= y % 2;
        var n = me(2, Math.floor(0.01 * this.c1));
        n -= n % 2;
        l = Math.floor(0.82 * l);
        cH.fillRect(y, l, y, n);
        cH.fillRect(this.c1 - y - y, l, y, n);
        cH.fillRect(
          Math.floor(this.c1 - y - y + (y - n) / 2),
          Math.floor(l - (y - n) / 2),
          n,
          y
        );
        ...
        for (var y, n = this.mE[this.u9][1] - 1; 0 <= n; n--)
          (cH.textAlign = op),
            (y = Math.floor(
              this.uJ * this.cw +
                l +
                (n * ((1 - 2 * this.uJ) * this.cw - l)) / 9
            )),
            cH.fillText(
              this.mE[this.u9][0][n].value.toFixed(this.mE[this.u9][3]),
              Math.floor(this.uI * this.c1),
              y
            ),
            cH.fillText(
              n + 1 + this.mE[this.u9][6] + ".",
              Math.floor(this.uG * this.c1),
              y
            ),
            (cH.textAlign = mj),
            cH.fillText(
              this.mE[this.u9][0][n].name,
              Math.floor(this.uH * this.c1),
              y
            );
      };
    }
    function uh() {
      ...
      this.bp = function (F, M) {
        if (13 <= d) M ? (E = F) : E === F && e.saveString(200, F);
          ...
          jh.tr();
          E = F;
          A = Math.floor((q ? (r > s ? 0.6 : 0.45) : 0.4) * pO);
          t = A / bw.bz(17).width;
    ...
    function us() {
      ...
      this.bp = function () {
        if (bw.bx()) {
          var x = Math.floor((q ? 0.261 : 0.195) * bq);
          var A = Math.floor(0.9 * x),
            B = Math.floor(0.17 * A);
          g = q ? 2 * m7 : m7;
          l[0] = x / n[0].width;
          l[1] = A / n[1].width;
          ...
          t[4] = t[3];
          if (!y[0]) for (x = 0; 5 > x; x++) t[x] -= l[0] * n[0].height + g;
          if (!y[1]) for (x = 2; 5 > x; x++) t[x] -= l[1] * n[1].height + g;
        }
      };
      this.lE = function () {
        return !(7 === aJ.pe() && q);
      ...
      this.c7 = function (x, A, B) {
        ...
        for (C = y.length - 1; 0 <= C; C--)
          if (
            ...
            A > t[C] &&
            x < k[C] + l[C] * n[C].width &&
            A < t[C] + l[C] * n[C].height
          )
            return na.bp(z[C], B), !0;
        return !1;
      };
      this.cG = function () {
        if (n && this.lE()) {
          ...
          for (x = 0; 5 > x; x++)
            y[x] &&
              this.ut[x] &&
              (cH.setTransform(l[x], 0, 0, l[x], k[x], t[x]),
    ...
    function kC() {
      ...
      this.bp = function () {
        ...
        this.uy = Array(7);
        this.cw = Math.floor((q ? 0.123 : 0.093) * bq);
        this.c1 = Math.floor((q ? 3.96 : 4.2) * this.cw);
        this.f7 = Math.floor(0.025 * this.c1);
        var y = Math.floor(0.26 * this.cw),
          n = bt + y + bu;
        this.uy[0] = {
          fK: 0,
          fL: 0,
          c1: Math.floor(0.6 * this.c1 - this.f7 / 2),
          cw: this.cw,
          ne: "Multiplayer",
          font: n,
      ...
      this.rx = function () {
        this.fL = Math.floor(0.54 * cB);
        this.uy[0].fK = Math.floor(0.5 * gE - 0.5 * this.c1);
        ...
        this.uy[0].fL = Math.floor(0.54 * cB);
        this.uy[1].fL = this.uy[0].fL;
        this.uy[2].fL = Math.floor(
          (cB - this.uy[2].cw - this.uy[3].cw - this.f7) / 2
        );
        this.uy[3].fL = this.uy[2].fL + this.uy[2].cw + this.f7;
        this.uy[4].fL = Math.floor(
          (cB - this.uy[4].cw - this.uy[5].cw - this.f7) / 2
        );
        this.uy[5].fL = this.uy[6].fL =
          this.uy[4].fL + this.uy[4].cw + this.f7;
      };
      this.v2 = function () {
        g(0);
        g(1);
      ...
      this.pV = function (y, n, z, x) {
        for (var A = z; A < z + x; A++)
          if (
            y >= this.uy[A].fK &&
            n >= this.uy[A].fL &&
            y <= this.uy[A].fK + this.uy[A].c1 &&
            n <= this.uy[A].fL + this.uy[A].cw
          )
            return A;
        return -1;
      };
    ...
    function v8() {
      ...
      this.bp = function () {
        r < 2 * s
          ? (this.c1 = Math.floor((q ? 0.94 : 0.4) * r))
          : ((this.cw = Math.floor((q ? 0.88 : 0.4) * s)),
      ...
      this.vD = function () {
        ...
        if (6 > k.length)
          ...
          for (var t = 2; 0 <= t; t--)
            this.colors[0][t] = g(
              4 * (10 * parseInt(k[2 * t]) + parseInt(k[2 * t + 1]))
            );
        this.vF();
      };
      this.vG = function () {
        return [
          as(this.colors[0][0], 4),
          as(this.colors[0][1], 4),
          as(this.colors[0][2], 4),
        ];
      };
      this.c7 = function (k, t) {
        ...
        if (0 > k || 0 > t || k >= this.c1 - 1 || t >= this.cw - 1)
          return (
            (this.lE = !1), 0 === aJ.pe() && jn.cE(0, !0), (c4.c5 = !0), !1
          );
        if (
          k < this.f7 ||
          t < this.f7 ||
      ...
      this.lo = function (k) {
        0 !== this.v9 &&
          ((k -= 2 * this.f7 + this.vA + (gE - this.c1) / 2),
      ...
      this.cG = function () {
        ...
        cH.font = bt + Math.floor(0.8 * this.vA) + bu;
        cH.textBaseline = cI;
        cH.textAlign = cJ;
        this.vK(0);
        cH.lineWidth = p2;
      ...
      this.vL = function (k) {
        ...
        cH.fillRect(
          2 * this.f7 + this.vA,
          this.f7 + k * (this.f7 + this.vC),
          Math.floor((this.colors[this.ny][k] * this.vB) / 255),
          this.vC
        );
        cH.strokeStyle = cK;
        cH.strokeRect(
    ...
    function kD() {
      ...
      this.lx = function () {
        x = Math.floor((q ? 0.5 : 0.25) * bq);
        A = x + 12;
        z = Math.floor(0.125 * x);
        C = 3 * z;
        B = Math.floor(0.225 * x);
        M = Math.floor(0.3 * z);
        F = or + M + bu;
      };
      this.vV = function (L) {
      ...
      this.c7 = function (L, P) {
        var I = Math.floor((gE - A) / 2),
          O = Math.floor(0.5 * (cB - cA - z - B)) + z + cA;
        return L > I && L < I + A && P > O && P < O + B
          ? (this.ve(), jk.lo(L, P, !1), !0)
          : !1;
      };
      this.ve = function () {
        eD.vf(3260);
      ...
      this.dF = function () {
        6 === aJ.pe() &&
          (J ? c4.gf > H + 2e4 && jm.vd(3250) : c4.gf > H + 2e4 && t(),
          (y += 0.07 * n * (16 > y ? 5 + y : 84 < y ? 105 - y : 17)),
          100 < y ? ((y = 100), (n = -1)) : 0 > y && ((y = 0), (n = 1)),
          (E =
            "rgba(0," +
            Math.floor(190 - 1.9 * y) +
            "," +
            Math.floor(120 - 1.2 * y) +
            "," +
            (0.4 + 0.004 * y) +
            ")"),
          (G =
    ...
    function kE() {
      ...
      this.cG = function () {
        if (8 !== g && 10 !== g) {
          ...
          jj.cG();
          ji.cG();
          var k = Math.floor(0.3 * cB),
            t = bw.lB("territorial.io"),
            l = (1.75 * cB) / t.width;
          l = l * t.width < 0.98 * gE ? (0.98 * gE) / t.width : l;
          cH.globalAlpha = 0.15;
          var y = Math.floor(0.5 * (gE - l * t.width));
          y = Math.floor(y / l);
          k = Math.floor(k - 0.5 * t.height * l);
          k = Math.floor(k / l);
    ...
    function w1() {
      ...
      this.bp = function () {
        this.c1 =
          r < 1 * s
            ? Math.floor((q ? 0.94 : 0.6) * r)
            : Math.floor((q ? 0.94 : 0.6) * s);
      ...
      this.cG = function () {
        ...
        cH.strokeRect(-1, -1, this.c1 + 2, this.cw + 2);
        for (
          var t = Math.floor(this.c1 / this.nn),
            l = (t - 2 * this.bB * t) / a5.c1,
            y = a5.nr - 1;
          0 <= y;
          y--
        )
          cH.setTransform(
            ...
            0,
            1,
            Math.floor(g + (y % this.nn) * t),
            Math.floor(k + as(y, this.nn) * t)
          ),
            a5.a7[y] && ((cH.fillStyle = oS), cH.fillRect(0, 0, t, t)),
            cH.setTransform(
              l,
              0,
              0,
              l,
              Math.floor(g + (y % this.nn) * t + this.bB * t),
              Math.floor(k + as(y, this.nn) * t + this.bB * t)
            ),
    ...
    function kF() {
      ...
      this.jW = function () {
        l = [];
        l.push({ l: "No Server Response", code: 1006 });
        l.push({ l: "Account successfully saved!", code: 3231 });
        l.push({ l: "Account Error", code: 3232 });
        l.push({ l: "No Servers Found", code: 3249 });
        l.push({ l: "Thanks for the vote.", code: 3252 });
        l.push({ l: "Please accept Cookies", code: 3265 });
        l.push({ l: "Invalid Password Format", code: 3266 });
        l.push({ l: "Lobby Timeout", code: 4207 });
        l.push({ l: "Invalid Username", code: 4214 });
        l.push({ l: "User already exists.", code: 4224 });
        l.push({ l: "No Client Response Error", code: 4229 });
        y = "Error ";
      };
    ...
    function kG() {
      ...
      this.lx = function () {
        var y = Math.floor((0.22 * jk.cw) / pS);
        k[0].input.style.font = bt + y + bu;
        k[0].input.style.padding = Math.floor(0.3 * y) + "px 5px";
      ...
      this.rx = function (y) {
        k[y].input.style.left =
          Math.floor((gE / pS - (jk.c1 / pS - 3) - 7) / 2) + "px";
        0 === y &&
          (k[y].input.style.bottom =
            Math.floor((cB - jk.fL + jk.f7) / pS) + "px");
      };
      this.cE = function (y, n) {
        k[y].lE !== n &&
          ((k[y].lE = n)
            ? document.body.appendChild(k[y].input)
            : document.body.removeChild(k[y].input));
      };
    ...
    function kj() {
      ...
      this.bp = function (y) {
        if (7 === aJ.pe()) {
          ...
          aJ.hu();
          y = bw.lB("loading");
          var n = ((q ? 0.396 : 0.25) * bq) / y.width;
          cH.setTransform(
            n,
            0,
            0,
            n,
            Math.floor((r - n * y.width) / 2),
            Math.floor((s - n * y.height) / 2)
          );
          cH.drawImage(y, 0, 0);
          cH.setTransform(1, 0, 0, 1, 0, 0);
        }
      ...
      this.eZ = function () {
        0 < l &&
          ...
          0 === c4.wO &&
            0 === c4.wP &&
            (0 === l && eD.jf < eD.wQ && (eD.jf += eD.wR),
            eD.rp(eD.jf, 5)));
      };
      this.wS = function () {
        10 === aJ.pe() && (k++, 2 <= k && (js.wT(g), (g = null)));
      };
    }
    function kg() {
      function g(N, T) {
        var U = E[N].getContext("2d", { alpha: !0 });
        ...
        U.setTransform(
          ...
          0,
          Z,
          Math.floor((48 - Z * T.width) / 2),
          Math.floor((48 - Z * T.height) / 2)
        );
        U.drawImage(T, 0, 0);
          ...
          ? ((H = Math.floor(0.8 * 0.4 * bq)),
            ...
            r < s
              ...
              : ((F[1] = cA),
                ...
                (P = Math.floor(0.8 * H)),
                F[3] - D < H &&
                  ((P = Math.floor(0.8 * (F[3] - D))), (P = me(D, P))),
                (I = Math.floor(r - H / 2 - cA)),
                (O = Math.floor(cA + D + (F[3] - D) / 2)),
                (O = me(O, Math.floor(D + 2 * cA + P / 2)))))
          : ((H = Math.floor(0.2016 * bq)),
            (D = Math.floor(0.56 * H)),
            (F[2] = Math.floor(0.5 * r)),
            (F[3] = Math.floor(0.5 * s)),
            (F[1] = Math.floor(0.45 * (s - F[3]))),
            (F[0] = Math.floor((r - F[2]) / 2)),
            (P = Math.floor(0.75 * D)),
            (I = Math.floor(r / 2)),
            (O = Math.floor(F[1] + F[3] + (s - F[3] - F[1]) / 2)));
        L = bt + Math.floor((0.65 * D) / 4) + bu;
      ...
      this.c7 = function (N, T) {
        return 4 * ((N - I) * (N - I) + (T - O) * (T - O)) <= P * P
          ? (this.vt(), jk.lo(N, T, !1), !0)
          : y(N, T);
      };
      this.cG = function () {
        var N = 0,
        ...
        cH.setTransform(
          ...
          0,
          Z,
          Math.floor(I - 0.56 * Z * bw.bz(0).width),
          Math.floor(O - 0.5 * Z * U)
        );
        ...
        0 <= M
          ? ((cH.fillStyle = oS),
            cH.fillRect(r - H - cA, cA, H, Math.floor(0.25 * D)))
          : ((cH.fillStyle = on),
            cH.fillRect(
              r - H - cA,
              cA + Math.floor(0.25 * D),
              H,
              Math.floor(0.25 * D)
            ));
        cH.strokeStyle = cK;
          ...
          for (Z = 0; Z < x[1]; Z++) {
            ...
            for (U = 0; U < x[0]; U++) {
              ...
              var W = Math.floor(qa),
                la = Math.floor(T);
              if (null === G[Y].ls)
                (cH.fillStyle = oK), cH.fillRect(W, la, z, z);
              else {
                var ca = z / 128;
              ...
              cH.fillStyle = gH;
              cH.fillRect(W, Math.floor(la + 0.8 * n), z, 2);
              ...
              G[Y].jN &&
                ...
                cH.setTransform(
                  ...
                  0,
                  ca,
                  Math.floor(W + (n - ca * Y.width) / 2),
                  Math.floor(la + (n - ca * Y.height) / 2)
                ),
                (cH.globalAlpha = 0.6),
                cH.drawImage(Y, 0, 0),
                (cH.globalAlpha = 1),
    ...
    function kI() {
      function g(t, l, y, n, z, x, A, B, C) {
        ...
        0 <= B &&
          ((cH.fillStyle =
            "rgba(" + 22 * B + "," + (110 - 22 * B) + ",0,0.75)"),
          cH.fillRect(t, l, ((1 + B) * y) / 6, n));
        0 < C &&
          ((cH.fillStyle = "rgba(255,255,255,0.3)"),
          cH.fillRect(t, l, (C * y) / b8, n));
        cH.strokeStyle = cK;
        cH.strokeRect(t, l, y, n);
        0 !== x &&
          ((cH.fillStyle = cK),
          (cH.font = bt + Math.floor(x * n) + bu),
          cH.fillText(A, Math.floor(t + y / 2), Math.floor(l + 0.52 * n)));
      }
      var k = [0, 0, 0, 0];
      this.dz = [{ bD: 0, mv: 512 }];
      this.bp = function () {
      ...
      this.tr = function () {};
      this.lx = function () {
        k[2] = Math.floor((q ? 0.49 : 0.4) * bq);
        k[1] = Math.floor(
          (s - k[2] / 6 - this.dz.length * (cA + k[2] / 10)) / 2
        );
      ...
      this.xW = function (t) {
        var l;
        if (6 < t) this.dz = [{ bD: 0, mv: 512 }];
        else {
          this.dz = [];
          for (l = 0; l < t + 2; l++) this.dz.push({ bD: 0, mv: 0 });
          this.xX();
        }
      };
      this.vu = function () {
      ...
      this.lo = function (t, l) {
        return jv.lE && jv.lo(t, l) ? !0 : -1 === this.pV(t, l) ? !1 : !0;
      };
      this.xZ = function () {
        eD.jf = 0;
        eD.rp(0, 3) && iu.xa(0);
        ...
        if (dr.ds) dr.xb();
          ...
          t = 0 > t ? 7 : t;
          jJ(
            Math.floor(16384 * Math.random()),
            0,
            [{ name: jh.xc(), xd: cC.mE[2].ik.vG(), xe: 0 }],
            t,
            !1
          );
        }
      ...
      this.c7 = function (t, l) {
        ...
        if (2 === y) return this.tr(), this.xZ(), !0;
        if (dr.ds) return !1;
        if (27 === y)
          return (
            8 > this.dz.length &&
              (this.dz.push({ bD: 0, mv: b8 }),
              this.xX(),
              this.lx(),
              (c4.c5 = !0)),
            !0
        ...
        if (0 === y % 3)
          return (
            1 < this.dz.length &&
              (this.dz.splice(n, 1), this.lx(), (c4.c5 = !0)),
            !0
          );
        ...
        if (1 === y % 3) {
          ...
          0 > this.dz[n].bD
            ? (this.dz[n].bD = 5)
            : 5 < this.dz[n].bD && (this.dz[n].bD = 0);
          return (c4.c5 = !0);
        }
        c4.c5 = !0;
        var x = (t - (k[0] + k[2] - z)) / z - 0.5;
        x = Math.floor((0 > x ? -(x * x) : x * x) * b8);
        x = 0 === x ? 1 : x;
        z = b8;
        ...
        1 > this.dz[n].mv
          ? (this.dz[n].mv = 1)
          : this.dz[n].mv > z && (this.dz[n].mv = z);
        return !0;
      };
      this.xX = function () {
        for (
          var t = Math.floor(b8 / this.dz.length),
            l = b8 % this.dz.length,
            y = this.dz.length - 1;
          0 <= y;
          y--
      ...
      this.pV = function (t, l) {
        ...
        return 8 > this.dz.length
          ? ((A = k[1] + z + cA + this.dz.length * (x + cA)),
            l < A || l > A + x || t > k[0] + x ? -1 : 27)
          : -1;
      };
      this.cG = function () {
        var t;
        ...
        var l = (k[2] - 2 * cA) / 3,
          y = k[2] / 6;
        g(k[0], k[1], l, y, "rgba(128,0,0,0.75)", 0.4, "Back", -1, -1);
        g(
          k[0] + l + cA,
          k[1],
          l,
          y,
          "rgba(" + (dr.ds ? 128 : 0) + ",128,128,0.75)",
          0.4,
          dr.ds ? "Reset" : "Maps",
          -1,
          -1
        ...
        if (!dr.ds) {
          ...
          if (8 > this.dz.length) {
            ...
            t = k[0];
            cH.fillStyle = cK;
            l = me(2, Math.floor(0.5 * n));
            l -= l % 2;
            y = me(2, Math.floor(0.1 * n));
            y -= y % 2;
            n = Math.floor((n - l) / 2);
      ...
      this.xg = function (t) {
        return 0 === t && 1 === this.dz[t].mv
          ? "You"
          : dG.dl[this.dz[t].bD];
      };
      this.xh = function (t) {
        return 1 === this.dz[t].mv
          ? "1 Player"
          : this.dz[t].mv + " Players";
      };
    }
    function p9() {
      this.c1 = this.b3 = 0;
      ...
      this.bp = function () {
        this.mE = [];
        this.mE.push({ fK: 0, fL: 0, m3: q, ik: null });
        this.mE.push({ fK: 0, fL: 0, m3: !1, ik: new w1() });
        this.mE.push({ fK: 0, fL: 0, m3: !1, ik: new v8() });
        this.mE[2].ik.vD();
        this.b3 = this.mE.length;
        this.c1 = 0;
      };
      this.rx = function () {
        this.c1 = Math.floor((q ? 0.063 : 0.04) * bq);
        this.c1 += 4 - (this.c1 % 4);
        this.mE[0].fK = cA;
      ...
      this.pV = function (g, k) {
        ...
        for (var t = this.b3 - 1; 0 <= t; t--)
          if (
            g >= this.mE[t].fK &&
            k >= this.mE[t].fL &&
            g < this.mE[t].fK + this.c1 &&
            k < this.mE[t].fL + this.c1
          )
            return t;
        return -1;
      };
      this.xk = function () {
        for (var g = 2; 1 <= g; g--) if (this.mE[g].ik.lE) return !0;
        return !1;
      };
      this.ur = function () {
        return this.mE[1].ik.lE
          ? (this.mE[1].ik.c7(-5e3, -5e3, 0), !0)
          : this.mE[2].ik.lE
          ? (this.mE[2].ik.c7(-5e3, -5e3), !0)
          : !1;
      };
      this.c7 = function (g, k, t) {
        if (t) {
          if (this.mE[1].ik.lE) return this.mE[1].ik.c7(g, k, 0), !0;
          if (this.mE[2].ik.lE) return this.mE[2].ik.c7(g, k), !0;
        }
        g = this.pV(g, k);
        if (t) {
          if (0 === g)
            return (
              (this.mE[g].m3 = !this.mE[g].m3),
              (q = this.mE[g].m3),
              jt.xl(),
              a1(this.mE[0].m3, !1),
              !0
          ...
          if (1 <= g && 3 > g)
            return this.mE[g].ik.bp(), jh.tr(), (c4.c5 = !0);
        }
        return !1;
      };
      this.lo = function (g, k) {
        return this.mE[1].ik.lE
          ? (this.mE[1].ik.lo(g, k), !0)
          : this.mE[2].ik.lE
          ? (this.mE[2].ik.lo(g), !0)
          : !1;
      };
      ...
      this.xm = function (g, k) {
        ...
        cH.setTransform(
          ...
          l,
          this.mE[g].fK + t,
          this.mE[g].fL + (this.c1 - l * k.height) / 2
        );
        cH.drawImage(k, 0, 0);
      };
      this.xn = function () {
      ...
      this.xo = function () {
        ...
        for (var g = this.c1 / 4, k = 3; 0 <= k; k--)
          for (var t = 3; 0 <= t; t--)
            (cH.fillStyle =
              "rgb(" +
              Math.floor((367 * (k + 1) * (t + 1)) % 256) +
              "," +
              Math.floor((687 * (k + 1) * (t + 1)) % 256) +
              "," +
              Math.floor((651 * (k + 1) * (t + 1)) % 256) +
              ")"),
    ...
    function kJ() {
      ...
      function t() {
        ...
        k();
        5 <= d ? jm.vd(3232) : (jm.vd(3265), (vn.lE = !0), (vn.bs = -1));
        return !0;
      }
      function l() {
      ...
      this.xs = function (n) {
        return 0 === n
          ? jk.c1
          : 1 === n
          ? Math.floor(0.3 * jk.cw)
          : 2 === n
          ? jn.bz(0).input.style.font
          : y;
      };
      this.wD = function () {
      ...
      this.c7 = function (n, z) {
        ...
        1 === jk.pV(n, z, 1, 1)
          ? t() ||
            g() ||
            (a9(10), l() ? (this.tr(), w(y), dy.bp()) : jm.vd(4214))
          : 0 === jk.pV(n, z, 0, 1) && this.vs();
      };
      this.vs = function () {
        t() ||
          g() ||
          ...
          40 === y.charCodeAt(0) &&
          41 === y.charCodeAt(2)
            ? jl.vV((Math.abs(y.charCodeAt(1)) + 5) % eD.vX)
            : jl.vV(gI.xy - 1),
          l()
            ? bw.bx()
              ? (this.tr(), w(y), dr.pa(), jl.bp())
              : jm.vd(3228)
            : jm.vd(4214));
      };
      this.y2 = function () {
      ...
      this.cG = function () {
        if (this.y2()) {
          ...
          cH.setTransform(
            ...
            0,
            z,
            Math.floor((gE - z * n.width) / 2),
            jk.fL - z * n.height - 0.72 * jk.cw
          );
          cH.drawImage(n, 0, 0);
          cH.setTransform(1, 0, 0, 1, 0, 0);
          jk.v2();
    ...
    function kK() {
                  ...
                  (J = 4 * (B + C * G)),
                    ...
                    D[J + 1] - 20 > D[J + 2]
                      ...
                      : 50 > D[J] &&
                        ...
                        50 > D[J + 2] &&
                        (50 > D[J] + D[J + 1] + D[J + 2]
                          ? ((D[J + 1] = D[J + 1]), (D[J + 3] = 180))
                          : ((D[J + 1] = D[J + 1]),
                            (D[J + 3] =
                              180 +
                              Math.floor(
                                (75 * (D[J] + D[J + 1] + D[J + 2] - 50)) /
                                  100
                              ))));
            else if (6 === x)
              for (B = G - 1; 0 <= B; B--)
      ...
      this.lB = function (n) {
        for (var z = l.length - 1; 0 <= z; z--) if (l[z] === n) return t[z];
        return y;
      };
      this.bx = function () {
        return 0 === k;
    ...
    function kL() {
      ...
      this.hj = function (D) {
        for (var K = 3; 0 <= K; K--) if (this.yo(D + H[K])) return !0;
        return !1;
      };
      this.yp = function (D) {
    ...
    function kM() {
      ...
      function t() {
        ...
        z[1] =
          r < s ? Math.floor(1 + Math.random() * (Math.pow(2, 30) - 1)) : 0;
        z[2] = 1;
        z[3] = 1;
        z[4] = r < s ? 0 : 1;
        z[5] = 0;
      ...
      this.bp = function () {
        if (!(5 <= d || b)) {
          ...
          z = Array(x);
          for (
            var E, G = document.cookie.split(";"), F = G.length - 1;
            0 <= F;
            F--
          ) {
            G[F] = G[F].trim();
            ...
            3 < G[F].length &&
              ((C = n.indexOf(G[F].substring(0, 2))),
              (E = G[F].indexOf("=")),
              0 <= C && 2 === E
                ? (z[C] = G[F].substring(E + 1, G[F].length))
                : 0 < E && y(G[F].substring(0, E), "0", 0));
          }
          z[9] || (z[9] = "0");
          a: {
            for (C = x - 1; 0 <= C; C--)
          ...
          if (0 === fG[aw] || ae.zD(aw) === ae.af(aw)) k = 0;
            ...
            for (l = k - 2; 0 <= l; l -= 2) {
              ...
              if (y < b8 && 0 === fG[y]) g(l);
                ...
                var n = t[l + 1];
                if ((y >= b8 && lh(aw)) || (y < b8 && lm(aw, y)))
                  dx ? fM(aw, y, n) : iu.lW(n, y === b8 ? aw : y), g(l);
              }
            }
          }
      };
    ...
    function ks() {
      ...
      function k(z) {
        ...
        dr.dt.xB = 0;
        xJ(0, 0);
        "data:image/png;base64," !== z.substring(0, 22) &&
          (z = "data:image/png;base64," + z);
        var A = new Image();
        A.onload = function () {
          aZ = A.width;
          aa = A.height;
          4096 < aZ || 4096 < aa || 10 > aZ || 10 > aa
            ? (xJ(0, 0), alert("Image w & h must be between 10 and 4096."))
            : ((x6 = zg),
              (x7 = 0),
              (hv.width = aZ),
              (hv.height = aa),
      ...
      function t(z, x, A, B) {
        return "string" !== typeof z || z.length < x
          ? B
          : z.length > A
          ? z.substring(0, A)
          : z;
      ...
      this.zq = function (z) {
        ...
        this.dt.zl = y(z.selectableColor, !1);
      ...
      this.a08 = function () {
        var z,
          x = 0,
          A = this.dt.xY;
        for (z = 0; z < A; z++) this.dt.zy[z] > x && (x = this.dt.zy[z]);
    ...
    function kN() {
      ...
      this.fW = function (x, A) {
        var B,
          C = g(x);
        for (B = l[x] - 1; 0 <= B; B--) if (z[C + B] === A) return B;
        return -1;
      };
    ...
    function kP() {
      ...
      function t(Q) {
        return !gI.gJ.gK || 1e6 > ax[Q]
          ? 1
          : 1e7 > ax[Q]
          ? ta[0]
          : ta[Math.min(Math.floor(Math.log10(ax[Q])) - 6, 3)];
      }
      function l() {
        Y = !1;
        Z = 1;
        ...
        for (
          ...
          if (
            ...
            va =
              sa >= P && sa < L
                ? dW.a1F[b5.r1[va]] + z(sa).toFixed(3) + ")"
                : dW.a1G[b5.r1[va]];
            pa.fillStyle = va;
            ...
            if (0 < ca[ma]) {
              ...
              if (0 === sR[wa])
                if (a5.oH(la[wa])) {
                  ...
                  wa = la[wa];
                  var Aa = (0.9 * za) / a5.c1,
                    Da = Math.floor(va - 0.5 * Aa * a5.c1 - 0.05 * za);
                  W.globalAlpha = z(za);
                  Ba = t(Ba) * J[Ba];
                  for (
                    var Fa = Math.floor(
                        Ea - (0.5 * za) / Ba - 0.4 * za - Aa * a5.c1
                      ),
                      Ca = 0;
                    2 > Ca;
                    Ca++
                    ...
                    W.setTransform(Aa, 0, 0, Aa, Fa, Da),
                      ...
                      (Fa = Math.floor(Ea + (0.5 * za) / Ba + 0.4 * za));
                  W.globalAlpha = 1;
                  W.setTransform(1, 0, 0, 1, 0, 0);
                  y(pa, va, xa, 0, 0);
                } else
                  a5.oG(la[wa])
                    ? (n(pa, va, xa, la[wa], 0), y(pa, va, xa, 0, 1))
                    : (n(pa, va, xa, la[wa], 1), y(pa, va, xa, 1, 0));
              ...
              for (pa = 1; 5 > pa; pa++)
                0 < ca[za + pa * b8] &&
                  ...
                  W.setTransform(
                    ...
                    0,
                    Ca,
                    Math.floor(va - 0.5 * Ca * a5.c1 - 0.534 * wa * Aa),
                    Math.floor(xa + 1.4 * Ca * a5.c1)
                  ),
                  (W.globalAlpha = z(Aa)),
                  W.drawImage(
                    1 === Da
            ...
            pa < R ||
              ((W.font = bt + pa + bu),
              W.fillText(
                gI.gJ.gK ? gM[ma] : eP.gL(ax[ma]),
                ha,
                ia + Math.floor(0.78 * sa)
              ));
          }
      }
      function y(Q, X, fa, ra, ha) {
        ...
        W.setTransform(
          ...
          0,
          ia,
          Math.floor(Q - 0.5 * ia * S + 0.8 * ra * fa),
          Math.floor(X - 1.76 * ia * V - 0.82 * ha * fa)
        );
        W.globalAlpha = z(fa);
      ...
      function n(Q, X, fa, ra, ha) {
        ...
        W.setTransform(
          ...
          0,
          ia,
          Math.floor(Q - 0.5 * ia * a5.c1 - 0.8 * ha * fa),
          Math.floor(X - 1.5 * ia * a5.c1)
        );
        W.globalAlpha = z(fa);
      ...
      function B(Q, X, fa, ra) {
        return (
          b5.hp(Q, 4 * (fa * aZ + X)) &&
          b5.hp(Q, 4 * ((fa + ra - 1) * aZ + X))
        );
      }
      function C(Q, X, fa, ra) {
        return (
          b5.hp(Q, 4 * (fa * aZ + X)) &&
          b5.hp(Q, 4 * (fa * aZ + X + ra - 1))
        );
      }
      var E,
        G,
      ...
      this.bp = function () {
        ...
        if (gI.gJ.gK) {
          ...
          for (Q = b8 - 1; 0 <= Q; Q--)
            (K[Q] = Math.min(X, 2 * J[Q])), (J[Q] = X);
          ta[0] = 100 / (X * Math.floor(W.measureText("5 000 000").width));
          ta[1] = 100 / (X * Math.floor(W.measureText("50 000 000").width));
          ta[2] =
            100 / (X * Math.floor(W.measureText("500 000 000").width));
          ta[3] =
            100 / (X * Math.floor(W.measureText("1 000 000 000").width));
        } else k();
        for (Q = b8 - 1; 0 <= Q; Q--)
          12 > bU[Q]
            ? ((F[Q] = d0[Q] + 1),
              ...
              (H[Q] = 1),
              (D[Q] = 1))
            : ((F[Q] = d0[Q]), (M[Q] = d3[Q] + 1), (H[Q] = 4), (D[Q] = 2));
        if (fc) for (Q = 0; Q < cq; Q++) H[Q] = 0;
        S = bw.bz(4).width;
        V = bw.bz(4).height;
      };
      this.lx = function () {
      ...
      this.j7 = function () {
        for (var Q = 0; Q < cq; Q++)
          3 !== cz[Q] - d0[Q] || 3 !== d2[Q] - d3[Q]
            ? ((F[Q] = d0[Q] + (cz[Q] !== d0[Q] ? 1 : 0)),
              (M[Q] = d3[Q]),
              (H[Q] = 1),
              (D[Q] = 1))
            : ((F[Q] = d0[Q]), (M[Q] = d3[Q] + 1), (H[Q] = 4), (D[Q] = 2));
        ...
        Y &&
          (1 !== Z
            ? ((cH.imageSmoothingEnabled = !0),
              ...
              cH.setTransform(1, 0, 0, 1, 0, 0))
            : ((cH.imageSmoothingEnabled = !1), cH.drawImage(qa, -T, -U)));
      };
      ...
      this.eb = function (Q) {
        return (
          Q
            ? 0 === ++ba % gI.su[gI.gJ.a13]
            : 0 === c4.dU() % gI.su[gI.gJ.a13]
        )
          ? ((ba = 0), l(), !0)
          : !1;
      };
      ...
      this.dF = function () {
        if (4 <= ++G) {
          ...
          if (2 !== ec)
            for (Q = dY - 1; 0 <= Q; Q--)
              (fa = dZ[Q]), 0 < ca[fa] && 255 > ca[fa] && ca[fa]--;
        }
        Q = Math.floor(0.1 * dY);
        Q = 8 > Q ? 8 : Q;
        Q = Q > dY ? dY : Q;
        for (fa = E + Q - 1; fa >= E; fa--) {
          ...
          if (0 < H[X] && A(X, F[X], M[X], H[X], D[X])) {
            for (
              var ha, ia, ma, sa, pa = X, ua = !1, ya = 0;
              8 > ya;
              ya++
            ) {
              ia = H[pa] + 2;
            ...
            if ((ha = !ua)) {
              ...
              ya = H[ha];
              for (
                var va = 1 + Math.floor(0.02 * ya), xa = 1;
                5 > xa;
                xa++
              ) {
                ia = ya + xa * va;
                ...
                sa =
                  d0[ha] +
                  Math.floor(Math.random() * (cz[ha] - d0[ha] + 2 - ia));
                ma =
                  d3[ha] +
                  Math.floor(Math.random() * (d2[ha] - d3[ha] + 2 - ra));
                A(ha, sa, ma, ia, ra) &&
                  ((F[ha] = sa),
                  (M[ha] = ma),
                  (H[ha] = ia),
            ...
            if (ha) x(X);
              ...
              for (
                ...
                if (
                  ...
                  (ya =
                    d0[X] +
                    Math.floor(Math.random() * (cz[X] - d0[X] + 2 - pa))),
                  (ua =
                    d3[X] +
                    Math.floor(Math.random() * (d2[X] - d3[X] + 2 - sa))),
                  A(X, ya, ua, pa, sa))
                ) {
                  F[X] = ya;
                  M[X] = ua;
      ...
      this.mn = function (Q) {
        var X = Q + 2 * b8,
          fa = ca[X];
        return 0 < fa ? (e9.n9(50, Q), (ca[X] = 0), 255 === fa) : !1;
      };
      this.lk = function (Q) {
    ...
    function kQ() {
      ...
      this.bp = function () {
        ...
        var y = "K ; Y;E ; Z; z; s;S ".split(";"),
          n =
            "Kingdom of ; Kingdom;Empire of ; Empire; Dynasty; Sultanate;Sultanate of ".split(
              ";"
            );
        for (t = g.length - 1; 0 <= t; t--)
          for (l = y.length - 1; 0 <= l; l--)
            g[t] = g[t].replace(y[l], n[l]);
      };
      this.jW = function () {
        if (dr.ds && dr.dt.zp) {
          var t;
          ...
          for (l = ce.random(), t = cq; t < b8; t++)
            gM[t] = g[(t + l) % b8];
        else
          for (l = k.length, y = ce.random(), t = cq; t < b8; t++)
            gM[t] = "[Bot] " + k[(t + y) % l];
      };
      this.jX = function () {
        var t;
    ...
    function ko() {
      ...
      this.dF = function () {
        dx ||
          (30 === this.nf && 2140 <= c4.dU() && this.a1m(),
    ...
    function a29() {
      for (var g, k = dY - 1; 0 <= k; k--)
        bU[dZ[k]] <= as(hd[dZ[k]], 4)
          ? 1e3 >= bU[dZ[k]] &&
            (2 !== fG[dZ[k]] || 0 === bU[dZ[k]]) &&
            fm(dZ[k])
          : bU[dZ[k]] >= hd[dZ[k]]
          ? (hd[dZ[k]] = bU[dZ[k]])
          : ((g = as(hd[dZ[k]] - bU[dZ[k]], 1e3)),
            (hd[dZ[k]] -= 1 > g ? 1 : g));
    }
    function iw() {
      var g,
    ...
    function a2M() {
      ...
      d8();
      a2L = !0;
      d = (e = "undefined" !== typeof Android ? Android : null)
        ? e.getVersion()
        : 0;
      ...
      window.addEventListener("error", a2S, !0);
      tS = 10;
      xK = new a2T();
      h1 = new a2U();
      hB = new u2();
    ...
    function kR() {
      ...
      this.a2f = function () {
        ...
        cq <= k[0]
          ? ((this.e3 = t[0] - cq),
            (this.e4[1] = t[1] - as(t[1] * cq, k[0])),
            (this.e4[0] = 512 - this.e4[1] - t[0]))
          : cq <= k[1]
          ? ((this.e3 =
              t[0] - k[0] - as((t[0] - k[0]) * (cq - k[0]), k[1] - k[0])),
            (this.e4[0] = 512 - this.e3 - cq))
          : cq <= k[2]
          ? ((this.e4[0] =
              512 - k[1] - as((512 - k[1]) * (cq - k[1]), k[2] - k[1])),
            (this.e4[1] = 512 - cq - this.e4[0]))
          : cq <= k[3]
          ? ((this.e4[1] =
              512 - k[2] - as((512 - k[2]) * (cq - k[2]), k[3] - k[2])),
            (this.e4[2] = 512 - cq - this.e4[1]))
          : cq <= k[4]
          ? ((this.e4[2] =
              512 - k[3] - as((512 - k[3]) * (cq - k[3]), k[4] - k[3])),
            (this.e4[3] = 512 - cq - this.e4[2]))
          : cq <= k[5]
          ? ((this.e4[3] =
              512 - k[4] - as((512 - k[4]) * (cq - k[4]), k[5] - k[4])),
            (this.e4[4] = 512 - cq - this.e4[3]))
          : cq <= k[6]
          ? ((this.e4[4] =
              512 - k[5] - as((512 - k[5]) * (cq - k[5]), k[6] - k[5])),
            (this.e4[5] = 512 - cq - this.e4[4]))
          : (this.e4[5] = 512 - cq);
        t = this.e3;
      ...
      this.zT = function (k) {
        g.push({ player: k, mv: 14 + ce.cf(20) });
      };
      this.dF = function () {
        if (9 === dv) {
          var k;
          for (k = g.length - 1; 0 <= k; k--)
            0 >= --g[k].mv && (eA.n4(g[k].player, 0, 46), g.splice(k));
        }
      };
    }
    var aZ,
    ...
    function a2T() {
      ...
      this.dF = function () {
        if (8 === aJ.pe() && eV.gg()) this.rk = setTimeout(g, 16);
          ...
          this.a2x = l;
          this.a2x >= aa - 1
            ? (pp.putImageData(xH, 0, 0, 1, 1, aZ - 2, aa - 2),
              (c4.c5 = !0),
              this.xL())
            : this.a34 && (this.rk = setTimeout(g, 16));
        }
      };
      this.a3C = function (l, y, n) {
        k(
          l,
          Math.floor(this.a32[n] + (this.r1[n] * this.a33[y]) / 1e4) - xI[l]
        );
      };
        ...
        for (var B = 1 > z ? 1 : z; B <= A; B++)
          for (var C = n; C <= x; C++)
            if (((z = 4 * (C + B * aZ)), t(z))) {
              var E =
                this.a2y +
                ((this.a2z - this.a2y) * this.a33[C + aZ * B]) / 1e4;
              ...
              (E =
                this.a30 +
                ((this.a31 - this.a30) * this.a33[C + aZ * B]) / 1e4),
                Math.abs(l - C) > E ||
                  Math.abs(y - B) > E ||
                  ((G = Math.sqrt((l - C) * (l - C) + (y - B) * (y - B))),
                  G >= E || this.a3H(z, G, E, 0, this.r1[2]));
      };
    }
    function a2p() {
      2 === x6
        ? a3J([256], [256], [0, 205, 256], [500, 500, 0], [0, 0, 0])
        : 7 === x6
        ? a3J([512], [512], [0, 380, 512], [500, 500, 0], [0, 0, 0])
        : 8 === x6
        ? a3J([410], [410], [0, 120, 210], [0, 80, 640], [0, 0, 0])
        : 9 === x6 &&
          a3J(
            [512],
            [512],
    ...
    function a3J(g, k, t, l, y) {
      ...
      var E = Array(C),
        ...
        F = Array(C),
        M = jq.a3A();
      if (void 0 === y) for (y = Array(C), n = C - 1; 0 <= n; n--) y[n] = 0;
      for (n = 1; n < C; n++)
        (E[n] = t[n] - t[n - 1]),
          (G[n] = l[n] - l[n - 1]),
          (F[n] = y[n] - y[n - 1]);
    ...
    function a3X(g, k, t, l) {
      500 > k
        ? (l[g] = as(l[g] * k * 2, 1e3))
        : 500 < k && (l[g] += as(2 * (1e4 - l[g]) * (k - 500), 1e3));
    ...
    function kS() {
      ...
      this.a2q = function () {
        ...
        jp.a3b() &&
          ...
          ((t = bw.lB("arena")),
          pp.save(),
          (pp.globalAlpha = 1 === x6 ? 0.1 : 1),
          (pp.imageSmoothingEnabled = !0),
          (k = 2.8),
          pp.scale(k, k),
          pp.drawImage(
            t,
            Math.floor((aZ / k - t.width) / 2),
            Math.floor((0.5 * aa) / k - t.height / 2)
          ),
          pp.restore(),
          (t = bw.lB("territorial.io")),
          pp.save(),
          ...
          pp.drawImage(
            t,
            Math.floor(0.745 * (aZ / k - t.width)),
            Math.floor((0.422 * aa) / k - t.height / 2)
          ),
          pp.restore());
        vq = !0;
        c4.c5 = !0;
      ...
      this.jU = function () {
        ...
        var y = u7,
          n = xI;
        for (k = aZ - 1; 0 <= k; k--)
          (y[4 * k + 2] = 3), (y[l - 4 * k - 2] = 3);
        l = 4 * aZ;
        for (k = aa - 1; 0 <= k; k--)
          (y[k * l + 2] = 3), (y[k * l + l - 2] = 3);
        for (k = aZ * aa - 1; 0 <= k; k--)
          (l = 4 * k),
            3 !== y[l + 2] &&
              (n[l + 2] > n[l + 1] && n[l + 2] > n[l]
                ? (y[l + 2] = 2)
                : ((y[l + 2] = 1), t++));
        this.nG = (aZ - 2) * (aa - 2);
        this.nL = 0;
    ...
    function a2o(g) {
      ...
      x6 === a2u()
        ? (k =
            "")
        : x6 === a2u() + 1
        ? (k =
            "")
        : x6 === a2u() + 2
        ? (k =
        ...
        : x6 === a2u() + 3
        ? (k =
            "")
        : x6 === a2u() + 4
        ? (k =
        ...
        : x6 === a2u() + 5 &&
          (k =
            "");
      k = m.ia(k);
      var t = jp.bz(x6).a36,
        l = jp.bz(x6).a37;
      aZ = 1e3 * k[0] + k[1];
        ...
        for (J = 1; J < P; J++)
          (C[J] = C[J - 1] + L),
            1e4 <= C[J]
              ...
              : 0 > C[J]
              ? ((C[J] = 0), (L = -L))
              : ((L += 16384 <= ce.random() ? B : -B),
                (L = L < -A ? -A : L > A ? A : L));
      }
      function k(J, L, P, I) {
        if (P) for (P = 0; P < I; P++) y[L * n + J + P] = C[P];
        else for (P = 0; P < I; P++) y[L * n + J + P * n] = C[P];
      }
      function t(J, L) {
        var P = J - C[L - 1];
        if (0 !== P) {
    ...
    function km() {
      ...
      function k() {
        var x = Math.floor((q ? 0.145 : 0.09) * bq),
          A = Math.floor(2 * x),
          B = Math.floor(0.065 * (q ? 0.53 : 0.36) * bq);
        return {
          f8: r - x - B,
          f9: cA,
          i7: x,
          nV: Math.floor(0.35 * x),
          fA: r - A - B,
          i8: A,
        };
      }
      ...
      this.bp = function () {
        ...
        this.su[2] = 2;
        this.su[3] = 1;
        n[0][0] = { name: "More", id: 0, fC: 140, n6: 120, cm: 0 };
        n[0][1] = { name: "Lobby 1", id: 1, fC: 0, n6: 0, cm: 0 };
        n[0][2] = { name: "Settings", id: 2, fC: 0, n6: 0, cm: 0 };
        n[0][3] = { name: "More Information", id: 3, fC: 0, n6: 0, cm: 0 };
        n[0][4] = { name: a2B, id: 4, fC: 90, n6: 0, cm: 0 };
        n[1][0] = n[0][0];
        n[1][1] = { name: "Hide Usernames", id: 1, fC: 0, n6: 0, cm: 0 };
        n[1][2] = { name: "Hide Links", id: 2, fC: 0, n6: 0, cm: 0 };
        n[1][3] = { name: "Hide Zoom Buttons", id: 3, fC: 0, n6: 0, cm: 0 };
        n[1][4] = {
        ...
        n[1][5] = { name: "Resolution", id: 5, fC: 0, n6: 0, cm: 0 };
        n[1][6] = {
        ...
        n[1][9] = { name: "Reset Settings", id: 9, fC: 0, n6: 0, cm: 0 };
        n[1][10] = { name: "Back", id: 10, fC: 0, n6: 0, cm: 0 };
        n[2][0] = n[0][0];
        n[2][1] = { name: "Tutorial", id: 1, fC: 0, n6: 0, cm: 0 };
        n[2][2] = { name: "Player List", id: 2, fC: 0, n6: 0, cm: 0 };
        n[2][3] = { name: "Clan List", id: 3, fC: 0, n6: 0, cm: 0 };
        n[2][4] = { name: "Privacy Policy", id: 4, fC: 0, n6: 0, cm: 0 };
        !b &&
          5 > d &&
          n[2].push({ name: "Cookie Policy", id: 5, fC: 0, n6: 0, cm: 0 });
        n[2].push({ name: "Back", id: 6, fC: 0, n6: 0, cm: 0 });
        this.a4V();
        this.a4W();
      };
      this.a4U = function () {
      ...
      this.a4Z = function (x) {
        5 === x
          ? (n[1][x].name = "Resolution: " + eB.nI(100 * jt.a4a(), 1))
          : 6 === x
          ? (n[1][x].name =
              "Country Minimum Font Size: " +
              (4 > this.gJ.a0s ? 1 + this.gJ.a0s : 2 * (this.gJ.a0s - 1)))
          : 7 === x
          ? (n[1][x].name =
              "Leaderboard Refresh Rate: " +
              eB.nI(100 / this.su[this.gJ.sv], 1))
          : 8 === x &&
            (n[1][x].name =
              "Country Title Refresh Rate: " +
              eB.nI(100 / this.su[this.gJ.a13], 1));
      };
      this.c7 = function (x, A) {
        var B;
        if (!(7 <= aJ.pe())) {
              ...
              if (g(x, A, C, B))
                return (
                  ...
                  0 === z
                    ? 1 === B.id
                      ? ((gI.xy =
                          1 === gI.xy ? 2 : 2 === gI.xy ? eD.wQ : 1),
                        (B.name =
                          "Lobby " + (gI.xy === eD.wQ ? "1B" : gI.xy)),
                        (c4.c5 = !0))
                      : 2 === B.id
                      ? ((z = 1), (c4.c5 = !0))
                      : 3 === B.id && ((z = 2), (c4.c5 = !0))
                    ...
                    ? 1 === B.id
                      ...
                      ? (gI.gJ.a13++,
                        ...
                        (c4.c5 = !0))
                      : 9 === B.id
                      ? (gI.a4U(), gI.a4W(), gI.vJ(), jt.xl(), (c4.c5 = !0))
                      : 10 === B.id && ((z = 0), (c4.c5 = !0))
                    : 1 === B.id
                    ? (na.bp(oz, !0), na.bp(oz, !1))
                    : 2 === B.id
                    ? (na.bp(p0[0], !0), na.bp(p0[0], !1))
                    : 3 === B.id
                    ? (na.bp(p0[1], !0), na.bp(p0[1], !1))
                    : 4 === B.id
                    ? (12 <= d && e.setState(7),
                      na.bp(oy, !0),
                      na.bp(oy, !1))
                    : 5 === B.id
                    ? (na.bp(nb, !0), na.bp(nb, !1))
                    : 6 === B.id && ((z = 0), (c4.c5 = !0)),
                  !0
                );
            y = !1;
    ...
    function kV() {
      ...
      this.wE = function (x) {
        0 !== ec &&
          ...
          (t || g(),
          (y[x] = !0),
          -1 === l && ((l = setInterval(k, 20)), k()));
      };
      this.a2d = function (x) {
        if (0 !== ec && (t || g(), (y[x] = !1), -1 !== l)) {
          x = !1;
          for (var A = 3; 0 <= A; A--) x = x || y[A];
          x || this.gr();
        }
      };
      this.gr = function () {
          ...
          a: {
            ...
            if (!(2 > A))
              for (C = B, B = 0; B < A; B++)
                if (
                  ((C =
                    Math.abs(n - b5.gF(C)) >= Math.abs(x - b5.cF(C))
                      ? C + aV[n > y ? 1 : 3]
                      : C + aV[x > z ? 2 : 0]),
                  !b5.yo(C))
                ) {
    ...
    function a2Z() {
      ...
      this.lx = function () {
        dA &&
          ((y = Math.floor(0.18 * pO)),
          (y += y % 2),
          (n = Math.floor((7 * y) / 8)),
          (z = z ? z : document.createElement("canvas")),
          (z.width = y),
          (z.height = y),
          (x = z.getContext("2d", { alpha: !0 })),
          (x.lineWidth = 2),
          (x.strokeStyle = cK),
          g());
      };
    ...
    function ke() {
      ...
      function l() {
        ...
        x = Math.floor(0.5 + pS * B);
        A = Math.floor(0.5 + pS * C);
        if (x === gE && A === cB) return !1;
        gE = r = x;
        cB = s = A;
        pO = qr(r, s);
        bq = as(s + r, 2);
      ...
      this.a4a = function () {
        ...
        if (5 <= d) return 1 / x;
        var A = gI.gJ.a4Y;
        pS = 3 > A ? 0.5 + 0.25 * A : (0.5 + 0.125 * (A - 3)) * x;
        return pS / x;
      };
    }
    function kY() {
              ...
              if (b5.bG(y)) F = b8;
                ...
                if (!ch(t, F)) {
                  ...
                  0 >= M ||
                    ((M = l > M ? M : l),
                    (l -= M),
                    t === aw && (e9.nA(M, F), (b0.b1[16] += M)),
                    F === aw && (e9.nC(M, t), (b0.b1[10] += M)),
                    (ax[F] += M));
                  g(!0);
                  break a;
                }
    ...
    function kZ() {
      ...
      this.bp = function () {
        ...
        if (x) k = null;
          ...
          for (x = 3; 0 <= x; x--) {
            ...
            k[x].width = C;
            k[x].height = E;
            var G = k[x].getContext("2d", { alpha: !1 });
      ...
      this.hu = function () {
        var y = t ? 0 : -g;
        a4R(y, y, aZ - 2 * y, aa - 2 * y, h1.a5S, h1.a5T, h1.a5U, h1.a5V) ||
          ((cH.fillStyle = l), cH.fillRect(0, 0, gE, cB));
      };
      this.cG = function () {
        t ||
          (a4Q(0, -g, aZ, g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) &&
            cH.drawImage(k[0], h1.a5W, h1.a5X - g),
          a4Q(aZ, -g, g, aa + 2 * g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) &&
            cH.drawImage(k[1], h1.a5W + aZ, h1.a5X - g),
          a4Q(0, aa, aZ, g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) &&
            cH.drawImage(k[2], h1.a5W, h1.a5X + aa),
          a4Q(-g, -g, g, aa + 2 * g, h1.a5S, h1.a5T, h1.a5U, h1.a5V) &&
            cH.drawImage(k[3], h1.a5W - g, h1.a5X - g));
      };
    }
    function a21() {
      function g() {}
    ...
    function a2V() {
      ...
      this.a5n = function () {
        0 !== fG[aw] &&
          ((this.a5i[this.m6] = bU[aw]),
          (this.sD[this.m6] = ax[aw]),
          (this.td[this.m6] = ay.te(aw)),
          this.a5o(this.m6),
          this.m6++,
    ...
    function a2W() {
      ...
      this.lx = function () {
        ...
        this.c1 = Math.floor(
          (q && r < s ? 1 : q ? 0.8 : r < s ? 0.65 : 0.5) * this.c1
        );
        this.qO = Math.floor(1 + 0.006 * this.c1);
        this.c1 -= q && r < s ? 2 * m7 + this.qO : 0;
        this.cw = Math.floor(this.c1 / 1.618);
        this.i7 = Math.floor(1 + 0.02 * this.c1);
        this.nV = this.i8 = Math.floor(1 + 0.04 * this.c1);
        this.nW = Math.floor(1 + 0.075 * this.c1);
        this.a5q = Math.floor(this.c1 * (q ? 0.028 : 0.02));
        this.a5q = 6 > this.a5q ? 6 : this.a5q;
        this.a5r = Math.floor(0.028 * this.c1);
      ...
      this.a5v = function () {
        2 > this.bs
          ? (this.uc = c2.measureText(
              eP.gL(b0.max[this.bs]),
              bt + this.a5q + bu
            ))
          : 2 === this.bs &&
            (this.uc = c2.measureText(eB.nI(6, 2), bt + this.a5q + bu));
      ...
      this.nc = function () {
        ...
        0 === this.bs
          ...
          : 2 === this.bs
          ? this.a5y(g, k)
          : 3 === this.bs && (this.a5z(g, k), this.a60(g, k));
        cH.setTransform(1, 0, 0, 1, 0, 0);
      };
      this.a5w = function () {
      ...
      this.a5x = function (g, k, t) {
        ...
        for (t = b0.m6 - 2; 0 <= t; t--)
          cH.lineTo(
            (t * this.ud) / (b0.m6 - 1),
            this.xU - k * Math.sqrt(g[t])
          );
        cH.stroke();
        g = this.mB(g, k, 0.5);
        0.95 > g && cH.fillText(eP.gL(l), -this.i7, 0);
        0.05 < Math.abs(g - 0.5) &&
          cH.fillText(
            eP.gL(Math.floor(l / 4)),
            -this.i7,
            Math.floor(this.xU / 2)
          );
        0.05 < g && cH.fillText("0", -this.i7, this.xU);
      };
      this.a5y = function (g, k) {
        ...
        0.95 > t && cH.fillText(eB.nI(l, 2), -this.i7, 0);
        0.05 < Math.abs(t - 0.5) &&
          cH.fillText(eB.nI(l / 2, 2), -this.i7, Math.floor(this.xU / 2));
        0.05 < t && cH.fillText(eB.nI(0, 2), -this.i7, this.xU);
      };
      this.a5z = function (g, k) {
        var t;
        cH.setTransform(1, 0, 0, 1, g + 0.34 * this.c1, k + 2 * this.nV);
        cH.textAlign = op;
        var l = this.cw - 4 * this.nV - this.nW;
        for (t = 7; 0 <= t; t--) cH.fillText(b0.a5k[t], 0, (t * l) / 7);
        cH.setTransform(1, 0, 0, 1, g + 0.39 * this.c1, k + 2 * this.nV);
        cH.textAlign = mj;
        t = b0.b1[1];
      ...
      this.a60 = function (g, k) {
        var t;
        cH.setTransform(1, 0, 0, 1, g + 0.74 * this.c1, k + 2 * this.nV);
        cH.textAlign = op;
        var l = this.cw - 4 * this.nV - this.nW;
        cH.fillStyle = oP;
      ...
      this.mB = function (g, k, t) {
        if (0 > this.a5s || 1 < this.a5s) return 0.25;
        ...
        0.04 < this.a5s &&
          this.a66(
            0,
            this.xU - k * Math.pow(n, t),
            (l * this.ud) / (b0.m6 - 1),
            this.xU - k * Math.pow(n, t)
          );
        0.04 < n / b0.max[this.bs] &&
          this.a66(
            (l * this.ud) / (b0.m6 - 1),
            this.xU,
            (l * this.ud) / (b0.m6 - 1),
        ...
        cH.fillStyle = cK;
        cH.fillText(
          1 === t ? eB.nI(n / 100, 2) : eP.gL(Math.floor(n)),
          -this.i7,
          this.xU - k * Math.pow(n, t)
        );
        cH.textAlign = cJ;
    ...
    function a2Y() {
      this.wy =
        "rgba(130,130,130,0.88) rgba(130,12,12,0.88) rgba(12,130,12,0.88) rgba(12,12,130,0.88) rgba(130,130,12,0.88) rgba(130,12,130,0.88) rgba(12,130,130,0.88) rgba(130,130,130,0.88) rgba(0,0,0,0.88)".split(
          " "
        );
      this.t1 = [
        cK,
      ...
      this.bo =
        "White Red Green Blue Yellow Magenta Cyan White Black".split(" ");
      this.tt = [
        [255, 255, 255, 180],
        [255, 0, 0, 180],
        [0, 255, 0, 180],
      ...
      this.a6J = function (l, y, n, z) {
        ...
        for (x = cq - 1; 0 <= x; x--) {
          for (A = B; 1 <= A; A--)
            C[A - 1] =
              Math.abs(4 * l[x].xd[0] - g[A][0]) +
              Math.abs(4 * l[x].xd[1] - g[A][1]) +
              Math.abs(4 * l[x].xd[2] - g[A][2]);
          var E = 768;
          for (A = B - 1; 0 <= A; A--) {
            var G = (A + x) % B;
            C[G] < E && ((E = C[G]), (y[x] = G));
        ...
        for (x = 0; x < cq; x++)
          (z = B[y[x] + 1]),
            0 === this.dX[x] &&
              ...
              (n[z]++, (this.dX[x] = z));
        for (z = jG; 1 <= z; z--)
          for (x = cq - 1; 0 <= x && !(n[z] >= A); x--)
            0 === this.dX[x] && (n[z]++, (this.dX[x] = z));
      };
      this.a6M = function () {
        var l,
          y = new Uint16Array(jG);
        y[jG - 1] = b8;
        for (l = jG - 2; 0 <= l; l--) y[l] = dy.dz[l].mv;
        y[0]--;
        var n = 0 === y[0] ? 1 : 0;
        for (l = cq; l < b8; l++)
          (this.dX[l] = n + 1), y[n]--, 0 >= y[n] && n++;
      };
      this.a6N = function () {
    ...
    function bL(g) {
      for (var k = g.length, t = k - 1; 0 <= t; t--)
        b5.hp(aP, g[t]) || ((g[t] = g[k - 1]), g.pop(), k--);
    }
    function bO(g) {
      for (var k = g.length, t = k - 1; 0 <= t; t--)
        !b5.hp(aP, g[t]) &&
    ...
    function bR() {
      for (var g, k, t = aQ - 1; 0 <= t; t--)
        for (g = 3; 0 <= g; g--)
          (k = aS[t] + aV[g]),
            b5.ym(aP, k) && b5.yn(k) && (bM[aP].push(k), b5.b7(k, aP));
    }
    function bS() {
      var g;
      a: for (; d3[aP] < d2[aP]; ) {
    ...
    function lh(g) {
      ...
      for (k = 3; 0 <= k; k--) {
        var y = aV[k];
        for (t = 0; t < l; t++) if (b5.bG(bM[g][t] + y)) return !0;
      }
      return !1;
    }
    function lm(g, k) {
    ...
    function a2X() {
      ...
      this.a2c = function () {
        1 !== ec || !dx || fq.lw || fc || fq.m2();
        -1 === this.a6k && (this.a6k = setInterval(k, 2e3));
      };
      this.xt = function () {
        this.c5 = !0;
        -1 !== this.a6k && (clearInterval(this.a6k), (this.a6k = -1));
      };
      this.jg = function () {
        this.a6h = this.a6n;
        this.a6i = null;
    ...
    function a6o() {
      ...
      this.dF = function () {
        ...
        fc
          ...
          ? c4.gf >= this.gf &&
            ((this.gf +=
              this.a5j * Math.floor(1 + (c4.gf - this.gf) / this.a5j)),
            2 === ec || fq.lw ? e8() : (eE(), this.wP++, hB.u5()),
            this.bs++)
          : (fq.lw ? ed() : ((c4.c5 = !0), ea()), (this.bs = 0));
        eU();
        c4.c5 && ((c4.c5 = !1), hs());
      };
    }
    function a6q() {
      ...
      this.tg = function (k) {
        ...
        eB.tg(this.wO);
        this.wO === jI
          ? (fd.dF(), (this.wP = this.bs = this.wO = 0), (this.gf = c4.gf))
          : (this.wO++, eA.j7(), eA.eb(!0), hB.u5());
      };
      this.dF = function () {
        jt.dF();
        fc
          ? ((c4.c5 = eB.tg(-1) || c4.c5), ed())
          : 0 === this.bs
          ? c4.gf >= this.gf &&
            ((this.gf +=
              this.a5j * Math.floor(1 + (c4.gf - this.gf) / this.a5j)),
        ...
        this.a70
          ? 55 > t ||
            ...
            4 === t % 5
              ? ((k = k.getUTCHours()),
                59 === t && 15 <= k && 21 >= k
                  ? g("Upcoming Game of the Day", 0)
                  : 14 === t % 30
                  ? g("Upcoming Alliance Contest", 0)
                  : 29 === t % 30
                  ? g("Upcoming Battle Royale Contest", 0)
                  : g("Upcoming One-vs-One Game", 8))
              : 2 === t % 5 && g("Upcoming Zombie Game", 9))
          : 55 > t && (this.a70 = !0);
      };
    }
    function ka() {
      function g() {
        return Math.pow(Math.pow(y - t, 2) + Math.pow(n - l, 2), 0.5);
      }
      function k(z) {
              ...
              if (0 === k(n, 1)) {
                ...
                if (8 !== aJ.pe())
                  if (3 > t) eD.a26(y, 3208);
                    ...
                    0 === x
                      ? cD.uR(0, C, 10, 1, 0.36, 0.55, A)
                      : cD.uR(1, C, 100, 2, 0.47, 0.5, A);
                  }
              }
            else if (1 === z)
              if (y !== eD.w6) eD.close(y, 3239);
              else if ((6 === aJ.pe() && ju.bp(), 7 !== aJ.pe()))
                eD.close(y, 3251);
              else {
                x = [0, 0, 0, 0];
                A = k(n, 6);
                  ...
                  0 === z
                    ? 3 !== t
                      ...
                      : ((z = k(n, 9)),
                        ...
                        0 !== fG[z] &&
                          0 !== fG[aw] &&
                          ((x %= a5.a6), e9.mr(z, aw, x), eA.n4(z, 1, x)))
                    : 1 === z
                    ? 2 !== t
                      ? eD.a26(eD.jf, 3235)
                      : ((z = k(n, 9)),
                    ...
                    : ((z = k(n, 9)),
                      ...
                      0 !== fG[z] &&
                        ...
                        0 !== fG[aw] &&
                        eQ.a1j(1, [z], !0) &&
                        (eA.n4(z, 3, 96), eA.n4(x, 4, 96), e9.n7(z, x)))));
        }
      };
      this.wT = function (y) {
        l = 1;
    ...
    function kh() {
      ...
      this.lx = function () {
        var k = as(zg + (zg % 2), 2);
        k = s - k * cA;
        this.xV[2] = q ? Math.floor(0.75 * pO) : Math.floor(0.5 * pO);
        this.xV[3] = Math.floor(1.2 * this.xV[2]);
        this.xV[3] > k &&
          ((this.xV[3] = k), (this.xV[2] = Math.floor(k / 1.2)));
      ...
      this.c7 = function (k, t) {
        ...
        if (
          ...
          return (this.lE = !1), !0;
        var y = Math.floor(0.13 * this.xV[3]);
        if (t < this.xV[1] + y)
          return (
            k > this.xV[0] + this.xV[2] - 1.2 * y && (this.lE = !1), !0
          );
      ...
      this.cG = function () {
        ...
        cH.textAlign = cJ;
        cH.textBaseline = cI;
        cH.font = bt + Math.floor(0.48 * y) + bu;
        cH.fillStyle = i1;
        ...
        fq.mB(
          Math.floor(this.xV[0] + this.xV[2] - 0.8 * t),
          Math.floor(this.xV[1] + 0.25 * t),
          Math.floor(0.5 * t)
        );
        cH.setTransform(1, 0, 0, 1, 0, 0);
      };
